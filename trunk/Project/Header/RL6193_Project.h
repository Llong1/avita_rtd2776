...
// Pcb Option
//--------------------------------------------------
#define _PCB_TYPE                                               _RL6193_AVITA

//--------------------------------------------------
// Model Option  ///Wesley180308_Move Model Type Define
//--------------------------------------------------
// model type
#define _YLI55161  0 // Single_Samsung55
...
//--------------------------------------------------
// Panel Option   //////Wesley180308_Panel Switch by Model
//--------------------------------------------------

#if(_MODEL_TYPE == _YLI55161)
#define _PANEL_TYPE                         _AU_LVDS_21_5_WUXGA     // _INNOLUX_LED_VBO_28_UHD
#elif(_MODEL_TYPE == _YLI55162)
#define _PANEL_TYPE                         _AU_LVDS_24_WUXGA   ///YLI55162 Use Panel  
#else
#define _PANEL_TYPE                         _AU_LVDS_23_WUXGA   ///KUI32171 Use Panel
#endif
...
#define _DCC_FUNCTION                                        _OFF//   _ON
#define _DCC_HISTOGRM_INFO                                      _OFF
#define _ICM_SUPPORT                                          _OFF//  _ON
#define _ICM_BRI_SUPPORT                                        _OFF
#define _SCM_SUPPORT                                            _OFF
#define _SIX_COLOR_SUPPORT                                   _OFF//   _ON
...
#define _OOR_V_FREQ_UPPER_BOUND                            800//     1500 // Unit in 0.1 HZ
