...
void ScalerTMDSRx3MHL3SetCmu(BYTE ucCmuSel);
#endif

void ScalerTMDSRx3MHL3SetCmu_EXINT0(BYTE ucCmuSel);
void ScalerTMDSRx3MHL3SetDFEInitial(void);
...
void ScalerTMDSRx3InterruptInitial(void)
{
    ...
    if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && ((GET_MHL3_RX3_ECBUS_MODE() == _ON) || (GET_MHL3_RX3_BIST_TESTING() == _ON)))
    {
        SET_TMDS_RX3_CLK_MODE(_TMDS_MHL_ECBUS_PHY_SETTING);

        // Set TMDS Offset = 1/128
        ScalerSetBit(P72_E7_HDMI_FREQDET_OFFSET, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));
...
void ScalerTMDSRx3MHL3SetDFEInitial(void)
{
    ...
    ScalerSetBit(P7C_A0_L0_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
    ...
    ScalerSetBit(P7C_E2_GAIN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT5 | _BIT2));
    ...
    // Tap0 Max is 21
    ScalerSetByte(P7C_E6_LIMIT_1, 0x35);
    ...
    ScalerSetBit(P7C_E9_LIMIT_4, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
    ScalerSetBit(P7C_EA_LIMIT_5, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3), (_BIT5 | _BIT4));

    // Tap4 Max is 1, Min is -6
    ScalerSetBit(P7C_EA_LIMIT_5, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit(P7C_EB_LIMIT_6, ~(_BIT7 | _BIT6), _BIT6);
    ScalerSetBit(P7C_EB_LIMIT_6, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));

    // Tap0 Threshold
    ScalerSetBit(P7C_EF_RESET_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT5));

    // Set Vth Max = 8, Min = 0
    ScalerSetByte(P7C_F9_LIMIT_10, 0x80);
    ...
    ScalerSetBit(P7C_F8_GRAY_DEC_2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT5 | _BIT4));
    ...
    ScalerSetByte(P7C_A4_L0_INIT_2, 0x0F);
    ...
    // Vth Initial Value = 6
    ScalerSetByte(P7C_A9_L0_INIT_7, 0x06);
...
void ScalerTMDSRx3MHL3SetDFEInitial_EXINT0(void) using 1
{
    ...
    // [3] Disable Running Length Detection
    // [2] bypass Blank out Case-3 Symbol
    ScalerSetBit_EXINT(P7C_A0_L0_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
    ScalerSetBit_EXINT(P7C_B0_L1_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
    ScalerSetBit_EXINT(P7C_C0_L2_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
...
void ScalerTMDSRx3MHL3AcdrSetPhy(void)
{
    ...
    ScalerTMDSRx3MHL3SetDFEInitial();
}
...
void ScalerTMDSRx3SetDFEInitial_EXINT0(void) using 1
{
    ...
    if(GET_D3_INPUT_PIXEL_CLK() >= 3400)
    {
    ...
    if(ScalerGetBit_EXINT(P7C_1B_CMU_01, _BIT0) == _BIT0) // DCDR
    {
        ...
        else if(GET_D3_INPUT_PIXEL_CLK() <= 700)
        {
            // LE Max = 24, Initial = 6
            ScalerSetByte_EXINT(P7C_A2_L0_LIMIT_INIT, 0x86);
            ScalerSetByte_EXINT(P7C_B2_L1_LIMIT_INIT, 0x86);
    ...
    ScalerSetByte_EXINT(P7C_A4_L0_INIT_2, 0x0C);
    ScalerSetByte_EXINT(P7C_B4_L1_INIT_2, 0x0C);
    ScalerSetByte_EXINT(P7C_C4_L2_INIT_2, 0x0C);
...
void ScalerTMDSRx3SetPhy_EXINT0(void) using 1
{
    ...
    if(GET_D3_INPUT_PIXEL_CLK() <= 2000)  // DCDR
    {
        // [3:0] reg_en_ana_cdr = 4'b0000 --> Disable Analog CDR
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT3, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT2, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT1, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT0, 0x00);

        // [0] En_APLL_Lane2 = 1'b1 --> Enable Lane2 VCO as CMU
        ScalerSetBit_EXINT(P7C_1B_CMU_01, ~_BIT0, _BIT0);

        if((GET_D3_INPUT_PIXEL_CLK() <= 1000) && (ScalerGetBit_EXINT(P7C_17_BANDGAP_03, _BIT1) == _BIT1))  // MHL mode
        {
    ...
    else  // ACDR
    {
        ...
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT3, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT2, _BIT2);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT1, _BIT1);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7C_2A_ANA_CDR_00, ~_BIT0, _BIT0);
    ...
    if(ScalerGetBit_EXINT(P7C_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
    {
        ...
        {
            if(GET_D3_INPUT_PIXEL_CLK() <= 1500)
            {
        ...
        else  // MHL 24bit Mode
        {
            ...
            else if(GET_D3_INPUT_PIXEL_CLK() <= 1500)
            {
                // Analog CDR Auto FLD Counter
                // ref_conuter = 40
                // cdr_counter = 480
...
#endif
    {
...
#endif
        {
            ...
            else if(GET_D3_INPUT_PIXEL_CLK() <= 750)
            {
                // Analog CDR Auto FLD Counter
                // ref_conuter = 50
                // cdr_counter = 400
    ...
    else if(GET_D3_INPUT_PIXEL_CLK() <= 3400)
    {
        // [3:1] LE_lowgain_highboost = 110 --> LE HighBoost Mode
        ScalerSetBit_EXINT(P7C_22_CMU_08, ~(_BIT3 | _BIT2 | _BIT1), (_BIT3 | _BIT2));
    }
    else
    {
    ...
    if(ScalerGetBit_EXINT(P7C_1B_CMU_01, _BIT0) == _BIT0) // DCDR
    {
        ...
        if(GET_D3_INPUT_PIXEL_CLK() <= 375) // TMDS Clock < 375
        {
        ...
        else if(GET_D3_INPUT_PIXEL_CLK() <= 1000)// 375~1000
        {
    ...
    else if(GET_D3_INPUT_PIXEL_CLK() <= 3400) // 2000~3400 Analog CDR
    {
        // [7] cmu_en = 1'b1 --> Enable CMU PLL
        ScalerSetBit_EXINT(P7C_1B_CMU_01, ~_BIT7, _BIT7);
        ...
        if(ScalerGetBit_EXINT(P7C_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
        {
            if(GET_D3_INPUT_PIXEL_CLK() > 2500) // for 2500~3000 MHL PP Mode
            {
...
#endif
        {
            if(GET_D3_INPUT_PIXEL_CLK() > 2900) // for 2900~3400 10M Cable Case
            {
                // Start to Record LE Max/Min
                ScalerSetBit_EXINT(P7C_F2_COEF_3, ~_BIT0, _BIT0);
    ...
    if(ScalerGetBit_EXINT(P7C_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
    {
        ...
        ScalerSetBit_EXINT(P7C_32_ANA_CDR_08, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerGetByte_EXINT(P7C_35_ANA_CDR_11) & 0x7F));
        ScalerSetBit_EXINT(P7C_33_ANA_CDR_09, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerGetByte_EXINT(P7C_36_ANA_CDR_12) & 0x7F));
        ScalerSetBit_EXINT(P7C_34_ANA_CDR_10, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerGetByte_EXINT(P7C_37_ANA_CDR_13) & 0x7F));

        // [7] reg_auto_mode = 1'b0 --> FLD Manual Mode
        ScalerSetBit_EXINT(P7C_2B_ANA_CDR_01, ~_BIT7, 0x00);
...
void ScalerTMDSRx3IntHandler_EXINT0(void) using 1
{
    ...
    if((ScalerGetByte_EXINT(P72_EF_HDMI_ERROR_TH) & 0xC0) == 0xC0)
    {
        ...
        if(GET_D3_TMDS_MODE() == _TMDS_MHL_MODE)
        {
            ...
            if((ScalerGetBit_EXINT(P7C_1B_CMU_01, _BIT1) == _BIT1) &&
               (ScalerGetBit_EXINT(P7C_1B_CMU_01, (_BIT6 | _BIT5 | _BIT4)) == (_BIT6 | _BIT5)) &&
               ((GET_MHL3_RX3_ECBUS_MODE() == _ON) || (GET_MHL3_RX3_BIST_TESTING() == _ON)) &&
               (ScalerGetByte_EXINT(P2C_5F_ECBUS_RESERVE_2) == 0x00))
            {
                // Monitoring eCBUS Clk Status Stable, Process MHL3 Set CMU 75M->3G
                SET_MHL3_RX3_ECBUS_CLK_STABLE();

                // MHL eCBUS-S 3.0G Set PHY
                ScalerTMDSRx3MHL3SetCmu_EXINT0(_ECBUS_CLK);


                //----------- D-PHY ------------//

                // Release ecbus_dphy_rstn
                ScalerSetBit_EXINT(P2C_A0_ECBUS_DPHY_CTRL, ~_BIT7, _BIT7);

                // Set FWD Clk Rising Edge Re-Calibrat Times
                pData_EXINT[0] = 10;

                while(((pData_EXINT[0]--) > 0) && ((ScalerGetByte_EXINT(P2C_A2_ECBUS_DPHY_EDGE_RESULT) < 0x05) || (ScalerGetByte_EXINT(P2C_A2_ECBUS_DPHY_EDGE_RESULT) > 0x21)))
                {
                    // Enable FWD Edge Calibration
                    ScalerSetBit_EXINT(P2C_A1_ECBUS_DPHY_EDGE_CTRL, ~_BIT0, _BIT0);
                ...
                ScalerSetByte_EXINT(P2C_B6_ECBUS_DPHY_TX_PHASE_CONFIG_4, 0x00);
                ScalerSetByte_EXINT(P2C_B5_ECBUS_DPHY_TX_PHASE_CONFIG_3, 0x27);

                // Set BWD Tx Rising Phase K Initial (Manual Set BWD Tx Rising Phase) -> 0x0F (15)
                ScalerSetByte_EXINT(P2C_B4_ECBUS_DPHY_TX_PHASE_CONFIG_2, 0x0F);

                // Enable Tx Phase Manual Mode ---> Disable auto-K Boundaries
                ScalerSetBit_EXINT(P2C_A9_ECBUS_DPHY_CALIB_CTRL, ~_BIT6, 0x00);
                ...
                ScalerSetBit_EXINT(P2C_5F_ECBUS_RESERVE_2, ~_BIT0, _BIT0);
                ...
                if(GET_MHL3_RX3_BIST_TESTING() == _ON)
                {
                    ...
                    {
                        if(ScalerGetBit_EXINT(P2C_35_ECBUS_BIST_CONFIG, _BIT3) == 0x00)
                        {
                            // Force PRBS BIST Mode For eCBUS Electrical CTS - Enable Mac Force Test Out (Source Skip eCBUS StartUp Flow)
                            ScalerSetBit_EXINT(P2C_52_ECBUS_TEST_FORCE_OUT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2));
                        }
                        else
                        {
                            // Force PRBS BIST Mode For eCBUS Electrical CTS - Enable Mac Force Test Out (Source Skip eCBUS StartUp Flow)
                            ScalerSetBit_EXINT(P2C_52_ECBUS_TEST_FORCE_OUT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT0));
                        }
                    }
                }
                ...
                ScalerSetBit_EXINT(P2C_01_ECBUS_STARTUP_CONFIG, ~(_BIT5 | _BIT4), (_BIT5 | _BIT4));

                // Set WD TimerEvent to Sent BWD COMMA1 12ms Later
                ScalerTimerWDActivateTimerEvent_EXINT0(12, _SCALER_WD_TIMER_EVENT_RX3_ECBUS_SEND_BWD_COMMA1);

                // Record eCBUS_INT Flow State-2 (BWD Start All 1 WD)
                ScalerSetBit_EXINT(P2C_5F_ECBUS_RESERVE_2, ~_BIT1, _BIT1);
            }
        }
        ...
        if((GET_D3_INPUT_PIXEL_CLK() >= 850) && (GET_D3_INPUT_PIXEL_CLK() <= 1500))
        {
        ...
        if((GET_TMDS_RX3_PHY_SET() == _FALSE) || ((bit)ScalerTMDSRx3CheckCDRStable_EXINT0(g_usTMDSRx3ClkCount) == _FALSE))
        {
            ...
            if(ScalerGetBit_EXINT(P72_CA_HDMI_DP, ~_BIT6) == _BIT6)
            {
                ...
                SET_TMDS_D3_OFFLINE_MEASURE_CLK(((DWORD)(_GDI_CLK_KHZ * 1024) * 2 / 100) / g_usTMDSRx3ClkCount);
            }
            else
            {
            ...
            if(GET_TMDS_RX3_HIGH_SPEED_MODE() == _TRUE)
            {
                SET_TMDS_D3_OFFLINE_MEASURE_CLK((GET_TMDS_D3_OFFLINE_MEASURE_CLK() * 4));
            }
#endif
            ...
            if(GET_D3_TMDS_MODE() == _TMDS_MHL_MODE)
            {
                ...
                if((GET_MHL3_RX3_ECBUS_MODE() == _ON) || (GET_MHL3_RX3_BIST_TESTING() == _ON))
                {
                    ...
                    ScalerTimerWDCancelTimerEvent_EXINT0(_SCALER_WD_TIMER_EVENT_RX3_ECBUS_CLK_UNSTABLE_TMOUT);

                    // Disable Stuck Low IRQ
                    ScalerSetBit_EXINT(P68_A4_CBUS_CTRL_04, ~(_BIT1 | _BIT0), 0x00);
                ...
                {
                    if((GET_D3_INPUT_PIXEL_CLK() >= 730) && (GET_D3_INPUT_PIXEL_CLK() <= 770))
                    {
...
#endif
        {
            ...
            if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && ((GET_MHL3_RX3_ECBUS_MODE() == _ON) || (GET_MHL3_RX3_BIST_TESTING() == _ON)))
            {
                ...
                if((GET_MHL3_RX3_AV_LINK_RATE() != _ECBUS_LINK_RATE_NULL) && (GET_MHL3_RX3_AV_LINK_N_CODE() != _ECBUS_N_CODE_NULL))
                {
                    ...
                    ScalerTMDSRx3MHL3DcdrSetPhy_EXINT0();
#elif(_MHL3_ECBUS_AVLINK_CDR_MODE == _ACDR_MODE)
                    // ECBUS Data Link Set PHY
                    ScalerTMDSRx3MHL3AcdrSetPhy_EXINT0();
#endif
    ...
    if((ScalerGetByte_EXINT(P72_E6_HDMI_FREQDET_CTRL) & 0x06) == 0x06)
    {
           ...
           (abs(GET_D3_INPUT_PIXEL_CLK() - ((GET_TMDS_D3_OFFLINE_MEASURE_CLK() << 3) / ((GET_COLOR_SPACE(_D3_INPUT_PORT) == _COLOR_SPACE_YCBCR422) ? _COLOR_DEPTH_8_BITS : GET_COLOR_DEPTH(_D3_INPUT_PORT)))) > (GET_D3_INPUT_PIXEL_CLK() >> 6)))
        {
            ...
            if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && (ScalerGetBit_EXINT(P7C_1B_CMU_01, _BIT4) == 0x00) && (GET_MHL3_RX3_ECBUS_MODE() == _ON))
            {
                // Disable MHL3 RGB/clock Output to avoid garbage
                ScalerSetBit_EXINT(P77_10_REG_MHL3_OUTPUT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
            }
            else
#endif // End of #if((_D3_INPUT_PORT_TYPE == _D3_MHL_PORT) && (_D3_MHL_VERSION >= _MHL_VERSION_3_0))
            {
            ...
            if(GET_D3_TMDS_MODE() == _TMDS_MHL_MODE)
            {
                ...
                if((GET_MHL3_RX3_ECBUS_MODE() == _ON) || (GET_MHL3_RX3_BIST_TESTING() == _ON))
                {
                    ...
                    {
                        ScalerTimerWDActivateTimerEvent_EXINT0(10, _SCALER_WD_TIMER_EVENT_RX3_ECBUS_CLK_UNSTABLE_TMOUT);
                    }
                    else
                    {
    ...
    if(((ScalerGetBit_EXINT(P72_A9_TMDS_ABC0, _BIT7) == _BIT7) && (ScalerGetBit_EXINT(P72_AA_TMDS_ABC1, _BIT4) == _BIT4)) ||
       ((ScalerGetBit_EXINT(P72_A9_TMDS_ABC0, _BIT5) == _BIT5) && (ScalerGetBit_EXINT(P72_AA_TMDS_ABC1, _BIT2) == _BIT2)))
    {
        // Disbale HDCP 1.4 IRQ
        ScalerSetBit_EXINT(P72_AA_TMDS_ABC1, ~(_BIT4 | _BIT2), 0x00);
...
BYTE ScalerTMDSRx3TMDSScanInputPort(BYTE ucInputType)
{
    ...
    if(GET_TMDS_RX3_PHY_SET() == _TRUE)
    {
        ...
        if((ScalerTMDSRx3CheckCDRStable(g_usTMDSRx3ClkCount) == _FALSE) ||
           ((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && (ScalerMHLRx3DetectClkMode() == _FALSE) && (GET_MHL3_RX3_ECBUS_MODE() == _OFF)) ||
           (ScalerTMDSRx3TMDSVideoDetect(_WAIT) == _TMDS_VIDEO_DATA_NONE))

#else // Else of #if(_D3_MHL_VERSION >= _MHL_VERSION_3_0)
        ...
        if((ScalerTMDSRx3CheckCDRStable(g_usTMDSRx3ClkCount) == _FALSE) || (ScalerTMDSRx3TMDSVideoDetect(_WAIT) == _TMDS_VIDEO_DATA_NONE))
#else
        if(ScalerTMDSRx3CheckCDRStable(g_usTMDSRx3ClkCount) == _FALSE)
#endif
        ...
        ScalerSetBit(P72_14_HDMI_CTRL_14, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (GET_D3_INPUT_PIXEL_CLK() / 10) >> 8);
        ScalerSetByte(P72_15_HDMI_CTRL_15, (GET_D3_INPUT_PIXEL_CLK() / 10));
        ...
        if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX3_ECBUS_MODE() == _ON))
        {
            ...
            if(ScalerMHL3Rx3DisplayFormatSetting() == _FALSE)
            {
#if(_MHL3_ECBUS_AVLINK_DEBUG_MESSAGE == _ON)
            ...
            ulPixelClkValue = ScalerMHL3Rx3StreamClkRegenerate();
            ...
            if(ScalerMHL3Rx3DisplayFormatGenFifoCheck() == _FALSE)
            {
                if(ScalerGetBit(P77_41_DPF_CTRL_0, _BIT4) == _BIT4)
                {
                    ScalerMHL3Rx3DisplatFormatGenAdjustHsyncDelay(ulPixelClkValue);
                }
                else
                {
                    ScalerMHL3Rx3DisplayFormatGenAdjustVsyncDelay(ulPixelClkValue);
                }
        ...
        if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX3_ECBUS_MODE() == _ON))
        {
            ...
            ScalerSetBit(P77_10_REG_MHL3_OUTPUT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
        }
        else
#endif // End of #if((_D3_INPUT_PORT_TYPE == _D3_MHL_PORT) && (_D3_MHL_VERSION >= _MHL_VERSION_3_0))
        {
...
bit ScalerTMDSRx3TMDSStableDetect(BYTE ucSourceType)
{
    ...
    if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX3_ECBUS_MODE() == _ON))
    {
        if(ScalerGetBit(P77_10_REG_MHL3_OUTPUT_0, _BIT7) == 0x00)
        {
            DebugMessageRx3("MHL3 Clock Output has been disable", ucSourceType);
            return _FALSE;
        }
    }
    else
...
#endif
    {
        ...
        if((GET_D3_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX3_ECBUS_MODE() == _ON))
        {
            if(GET_MHL3_RX3_MEASURE_VIEW_PIXEL_FORMAT() == _MHL3_VIDEO_24BIT_FORMAT)
            {
                if(ucSourceType == _SOURCE_HDMI)
                {
                    if(ScalerGetBit(P77_38_MHL_MEASURE_24, _BIT5) == _BIT5)
                    {
                        DebugMessageRx3("MHL3 Format Changed", ucSourceType);
                        return _FALSE;
                    }
                }
                else
                {
                    if(ScalerGetBit(P77_38_MHL_MEASURE_24, _BIT5) == 0x00)
                    {
                        DebugMessageRx3("MHL3 Format Changed", ucSourceType);
                        return _FALSE;
                    }
...
void ScalerTMDSRx3HotPlugEvent(void)
{
    ...
    {
        // Save Z0 Status
        ucZ0Status = ScalerGetBit(P7C_18_IMPEDANCE_00, (_BIT7 | _BIT6 | _BIT5 | _BIT4));
        ...
        // Restore Z0 Status
        ScalerSetBit(P7C_18_IMPEDANCE_00, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), ucZ0Status);
