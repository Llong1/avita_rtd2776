...
//****************************************************************************
void ScalerTMDSRx2Initial(BYTE ucInputPort);
...
void ScalerTMDSRx2MHL3SetCmu(BYTE ucCmuSel);
#endif

void ScalerTMDSRx2MHL3SetCmu_EXINT0(BYTE ucCmuSel);
void ScalerTMDSRx2MHL3SetDFEInitial(void);
...
void ScalerTMDSRx2Initial(BYTE ucInputPort)
{
...
#if((_D2_INPUT_PORT_TYPE == _D2_MHL_PORT) && (_D2_MHL_VERSION >= _MHL_VERSION_3_0))
    // Disable MHL3 Output
    ScalerSetBit(P76_10_REG_MHL3_OUTPUT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#endif
    ...
    ScalerSetBit(P71_C0_HDCP_CR, ~(_BIT7 | _BIT0), (_BIT7 | _BIT0));
#endif
...
#if(_D2_HDMI_2_0_SUPPORT == _OFF)
        // Set HDMI/DVI switch to Auto Mode
        ScalerSetDataPortBit(P71_C9_HDMI_AP, _P71_CA_PT_00_PORT_PAGE71_HDMI_SCR, ~(_BIT7 | _BIT6 | _BIT3), 0x00);
#endif
    }
}
...
void ScalerTMDSRx2InterruptInitial(void)
{
    ...
    if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && ((GET_MHL3_RX2_ECBUS_MODE() == _ON) || (GET_MHL3_RX2_BIST_TESTING() == _ON)))
    {
        SET_TMDS_RX2_CLK_MODE(_TMDS_MHL_ECBUS_PHY_SETTING);

        // Set TMDS Offset = 1/128
        ScalerSetBit(P71_E7_HDMI_FREQDET_OFFSET, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));
...
void ScalerTMDSRx2MHL3SetDFEInitial(void)
{
    ...
    ScalerSetBit(P7B_A0_L0_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
    ...
    ScalerSetBit(P7B_E0_MODE_TIMER, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT5 | _BIT4 | _BIT1));

    if(GET_MHL3_RX2_AV_LINK_N_CODE() == _ECBUS_N_CODE_6_0)
    {
        // [7:6] adapt_mode[1:0] = 2'b10 --> Amplitude-based Adaptation with Independent LE Loop
        ScalerSetBit(P7B_E0_MODE_TIMER, ~(_BIT7 | _BIT6), _BIT7);
    }
    else
    {
        // [7:6] adapt_mode[1:0] = 2'b11 --> Amplitude-based Adaptation without Independent LE Loop
        ScalerSetBit(P7B_E0_MODE_TIMER, ~(_BIT7 | _BIT6), (_BIT7 | _BIT6));
    }

    // Set DFE Delay Time
    // Turn On LE/Tap1~6 Simultaneously
    ScalerSetByte(P7B_E1_TIMER, 0x01);

    // Tap0, Tap1 Loop Gain 1/512
    ScalerSetBit(P7B_E2_GAIN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT5 | _BIT2));

    // Tap2, Tap3 Loop Gain 1/512
    ScalerSetBit(P7B_E3_GAIN_2, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT5 | _BIT2));

    // Tap4, Servo Loop Gain 1/512
    ScalerSetBit(P7B_E4_GAIN_3, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT5 | _BIT3));

    // LE Gain1 Loop Gain 1/256, LE Gain2 Loop Gain 0, LE Pre-Courser Gain 0
    ScalerSetBit(P7B_E5_GAIN_4, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1), (_BIT6 | _BIT4 | _BIT3));
    ScalerSetBit(P7B_FA_GAIN_PREC, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));

    // Tap0 Max is 21
    ScalerSetByte(P7B_E6_LIMIT_1, 0x35);

    if(GET_MHL3_RX2_AV_LINK_N_CODE() == _ECBUS_N_CODE_6_0)
    {
        // Tap1 Min is Tap1(-31)
        ScalerSetBit(P7B_E7_LIMIT_2, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    }
    else
    {
        // Tap1 Min is LE(-24) + Tap1(-31) = -55
        ScalerSetBit(P7B_E7_LIMIT_2, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT5 | _BIT4 | _BIT2 | _BIT1 | _BIT0));
    }

    // Tap2 Max is 6, Min is -6
    ScalerSetBit(P7B_E8_LIMIT_3, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3), (_BIT5 | _BIT4));
    ScalerSetBit(P7B_E8_LIMIT_3, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
    ScalerSetBit(P7B_E9_LIMIT_4, ~(_BIT7 | _BIT6), _BIT7);

    // Tap3 Max is 1, Min is -6
    ScalerSetBit(P7B_E9_LIMIT_4, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
    ScalerSetBit(P7B_EA_LIMIT_5, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3), (_BIT5 | _BIT4));

    // Tap4 Max is 1, Min is -6
    ScalerSetBit(P7B_EA_LIMIT_5, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit(P7B_EB_LIMIT_6, ~(_BIT7 | _BIT6), _BIT6);
    ScalerSetBit(P7B_EB_LIMIT_6, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1));

    // Tap0 Threshold
    ScalerSetBit(P7B_EF_RESET_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT5));

    // Set Vth Max = 8, Min = 0
    ScalerSetByte(P7B_F9_LIMIT_10, 0x80);

    // Set Vth/Servo-loop/Tap Divider
    ScalerSetByte(P7B_EC_LOOP_DIV_1, 0xA3);

    // Tap Divider = 10
    ScalerSetByte(P7B_ED_LOOP_DIV_2, 0xCA);
    ...
    ScalerSetByte(P7B_A2_L0_LIMIT_INIT, 0x8C);

    // Servo Initial = 16
    ScalerSetByte(P7B_A3_L0_INIT_1, 0x90);

    // Tap0 Initial Value = 15
    ScalerSetByte(P7B_A4_L0_INIT_2, 0x0F);

    if(GET_MHL3_RX2_AV_LINK_N_CODE() == _ECBUS_N_CODE_6_0)
    {
        // Tap1 Initial Value = 0 for Mode2 DFE
        ScalerSetByte(P7B_A5_L0_INIT_3, 0x00);
    }
    else
    {
        // Tap1 Initial Value = 12 for Mode3 DFE
        ScalerSetByte(P7B_A5_L0_INIT_3, 0x0C);
    }

    // Tap2~4 Initial Value = 0
    ScalerSetByte(P7B_A6_L0_INIT_4, 0x00);
    ScalerSetByte(P7B_A7_L0_INIT_5, 0x00);
    ScalerSetByte(P7B_A8_L0_INIT_6, 0x00);

    // Vth Initial Value = 6
    ScalerSetByte(P7B_A9_L0_INIT_7, 0x06);

    // Load Intial DFE Code
    ScalerSetByte(P7B_AA_L0_INIT_8, 0xFF);
    ScalerSetByte(P7B_AA_L0_INIT_8, 0x00);

    // DFE Loop Normal
    ScalerSetBit(P7B_EF_RESET_1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
    ScalerSetBit(P7B_EF_RESET_1, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));
...
void ScalerTMDSRx2MHL3SetDFEInitial_EXINT0(void) using 1
{
    ...
    // [3] Disable Running Length Detection
    // [2] bypass Blank out Case-3 Symbol
    ScalerSetBit_EXINT(P7B_A0_L0_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
    ScalerSetBit_EXINT(P7B_B0_L1_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));
    ScalerSetBit_EXINT(P7B_C0_L2_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5));

    if(ScalerGetBit_EXINT(P7B_1B_CMU_01, _BIT0) == _BIT0) // DCDR
    {
        if(GET_D2_INPUT_PIXEL_CLK() <= 1000)
        {
            // [7:6] adapt_mode[1:0] = 2'b10 --> Amplitude-based Adaptation with Independent LE Loop
    ...
    ScalerSetBit_EXINT(P7B_E2_GAIN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT5 | _BIT2));
    ...
    ScalerSetBit_EXINT(P7B_E5_GAIN_4, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT6 | _BIT2));
    ...
    {
        // Tap1 = 0~55 in Mode3
        ScalerSetByte_EXINT(P7B_E7_LIMIT_2, 0x37);
    }
    else
    {
        // Tap1 = 0~31 in Mode2
        ScalerSetByte_EXINT(P7B_E7_LIMIT_2, 0x1F);
    }

    // Tap2 = -25~10
    // Tap3~4 = -25~6
    ScalerSetByte_EXINT(P7B_E8_LIMIT_3, 0x56);
    ScalerSetByte_EXINT(P7B_E9_LIMIT_4, 0x46);
    ScalerSetByte_EXINT(P7B_EA_LIMIT_5, 0xC9);
    ScalerSetByte_EXINT(P7B_EB_LIMIT_6, 0x99);
    ...
    else if(GET_D2_INPUT_PIXEL_CLK() < 1000)
    {
...
void ScalerTMDSRx2MHL3AcdrSetPhy(void)
{
    ...
    ScalerTMDSRx2MHL3SetDFEInitial();
}
...
void ScalerTMDSRx2SetDFEInitial_EXINT0(void) using 1
{
    ...
    if(GET_D2_INPUT_PIXEL_CLK() >= 3400)
    {
    ...
    if(ScalerGetBit_EXINT(P7B_1B_CMU_01, _BIT0) == _BIT0) // DCDR
    {
        ...
        else if(GET_D2_INPUT_PIXEL_CLK() <= 700)
        {
            // LE Max = 24, Initial = 6
            ScalerSetByte_EXINT(P7B_A2_L0_LIMIT_INIT, 0x86);
            ScalerSetByte_EXINT(P7B_B2_L1_LIMIT_INIT, 0x86);
    ...
    ScalerSetByte_EXINT(P7B_A4_L0_INIT_2, 0x0C);
    ScalerSetByte_EXINT(P7B_B4_L1_INIT_2, 0x0C);
    ScalerSetByte_EXINT(P7B_C4_L2_INIT_2, 0x0C);
...
void ScalerTMDSRx2SetPhy_EXINT0(void) using 1
{
    ...
    if(GET_D2_INPUT_PIXEL_CLK() <= 2000)  // DCDR
    {
        // [3:0] reg_en_ana_cdr = 4'b0000 --> Disable Analog CDR
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT3, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT2, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT1, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT0, 0x00);

        // [0] En_APLL_Lane2 = 1'b1 --> Enable Lane2 VCO as CMU
        ScalerSetBit_EXINT(P7B_1B_CMU_01, ~_BIT0, _BIT0);

        if((GET_D2_INPUT_PIXEL_CLK() <= 1000) && (ScalerGetBit_EXINT(P7B_17_BANDGAP_03, _BIT1) == _BIT1))  // MHL mode
        {
    ...
    else  // ACDR
    {
        ...
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT3, 0x00);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT2, _BIT2);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT1, _BIT1);
        Delay5us_EXINT(g_ucDelay5usN);
        ScalerSetBit_EXINT(P7B_2A_ANA_CDR_00, ~_BIT0, _BIT0);
    ...
    else
    {
        ...
        if(GET_D2_INPUT_PIXEL_CLK() <= 3000)
        {
    ...
    if(ScalerGetBit_EXINT(P7B_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
    {
        ...
        {
            if(GET_D2_INPUT_PIXEL_CLK() <= 1500)
            {
        ...
        else  // MHL 24bit Mode
        {
            ...
            else if(GET_D2_INPUT_PIXEL_CLK() <= 1500)
            {
                // Analog CDR Auto FLD Counter
                // ref_conuter = 40
                // cdr_counter = 480
            ...
            else if(GET_D2_INPUT_PIXEL_CLK() <= 3000)
            {
                // Analog CDR Auto FLD Counter
                // ref_conuter = 80
                // cdr_counter = 480
...
#endif
    {
...
#endif
        {
            ...
            else if(GET_D2_INPUT_PIXEL_CLK() <= 750)
            {
                // Analog CDR Auto FLD Counter
                // ref_conuter = 50
                // cdr_counter = 400
    ...
    if(GET_D2_INPUT_PIXEL_CLK() <= 2000)
    {
    ...
    if(ScalerGetBit_EXINT(P7B_1B_CMU_01, _BIT0) == _BIT0) // DCDR
    {
        ...
        if(GET_D2_INPUT_PIXEL_CLK() <= 375) // TMDS Clock < 375
        {
        ...
        else if(GET_D2_INPUT_PIXEL_CLK() <= 1000)// 375~1000
        {
    ...
    else if(GET_D2_INPUT_PIXEL_CLK() <= 3400) // 2000~3400 Analog CDR
    {
        // [7] cmu_en = 1'b1 --> Enable CMU PLL
        ScalerSetBit_EXINT(P7B_1B_CMU_01, ~_BIT7, _BIT7);
        ...
        if(ScalerGetBit_EXINT(P7B_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
        {
            if(GET_D2_INPUT_PIXEL_CLK() > 2500) // for 2500~3000 MHL PP Mode
            {
...
#endif
        {
            if(GET_D2_INPUT_PIXEL_CLK() > 2900) // for 2900~3400 10M Cable Case
            {
                // Start to Record LE Max/Min
                ScalerSetBit_EXINT(P7B_F2_COEF_3, ~_BIT0, _BIT0);
    ...
    if(ScalerGetBit_EXINT(P7B_17_BANDGAP_03, _BIT1) == _BIT1)  // MHL Mode
    {
        ...
        ScalerSetBit_EXINT(P7B_32_ANA_CDR_08, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerGetByte_EXINT(P7B_35_ANA_CDR_11) & 0x7F));
        ScalerSetBit_EXINT(P7B_33_ANA_CDR_09, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerGetByte_EXINT(P7B_36_ANA_CDR_12) & 0x7F));
        ScalerSetBit_EXINT(P7B_34_ANA_CDR_10, ~(_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (ScalerGetByte_EXINT(P7B_37_ANA_CDR_13) & 0x7F));

        // [7] reg_auto_mode = 1'b0 --> FLD Manual Mode
        ScalerSetBit_EXINT(P7B_2B_ANA_CDR_01, ~_BIT7, 0x00);
...
void ScalerTMDSRx2IntHandler_EXINT0(void) using 1
{
    ...
    if((ScalerGetByte_EXINT(P71_EF_HDMI_ERROR_TH) & 0xC0) == 0xC0)
    {
        ...
        if(GET_D2_TMDS_MODE() == _TMDS_MHL_MODE)
        {
            ...
            if((ScalerGetBit_EXINT(P7B_1B_CMU_01, _BIT1) == _BIT1) &&
               (ScalerGetBit_EXINT(P7B_1B_CMU_01, (_BIT6 | _BIT5 | _BIT4)) == (_BIT6 | _BIT5)) &&
               ((GET_MHL3_RX2_ECBUS_MODE() == _ON) || (GET_MHL3_RX2_BIST_TESTING() == _ON)) &&
               (ScalerGetByte_EXINT(P2B_5F_ECBUS_RESERVE_2) == 0x00))
            {
                // Monitoring eCBUS Clk Status Stable, Process MHL3 Set CMU 75M->3G
                SET_MHL3_RX2_ECBUS_CLK_STABLE();

                // MHL eCBUS-S 3.0G Set PHY
                ScalerTMDSRx2MHL3SetCmu_EXINT0(_ECBUS_CLK);


                //----------- D-PHY ------------//

                // Release ecbus_dphy_rstn
                ScalerSetBit_EXINT(P2B_A0_ECBUS_DPHY_CTRL, ~_BIT7, _BIT7);

                // Set FWD Clk Rising Edge Re-Calibrat Times
                pData_EXINT[0] = 10;

                while(((pData_EXINT[0]--) > 0) && ((ScalerGetByte_EXINT(P2B_A2_ECBUS_DPHY_EDGE_RESULT) < 0x05) || (ScalerGetByte_EXINT(P2B_A2_ECBUS_DPHY_EDGE_RESULT) > 0x21)))
                {
                    // Enable FWD Edge Calibration
                    ScalerSetBit_EXINT(P2B_A1_ECBUS_DPHY_EDGE_CTRL, ~_BIT0, _BIT0);
                ...
                ScalerSetByte_EXINT(P2B_B6_ECBUS_DPHY_TX_PHASE_CONFIG_4, 0x00);
                ScalerSetByte_EXINT(P2B_B5_ECBUS_DPHY_TX_PHASE_CONFIG_3, 0x27);

                // Set BWD Tx Rising Phase K Initial (Manual Set BWD Tx Rising Phase) -> 0x0F (15)
                ScalerSetByte_EXINT(P2B_B4_ECBUS_DPHY_TX_PHASE_CONFIG_2, 0x0F);

                // Enable Tx Phase Manual Mode ---> Disable auto-K Boundaries
                ScalerSetBit_EXINT(P2B_A9_ECBUS_DPHY_CALIB_CTRL, ~_BIT6, 0x00);
                ...
                ScalerSetBit_EXINT(P2B_5F_ECBUS_RESERVE_2, ~_BIT0, _BIT0);
                ...
                if(GET_MHL3_RX2_BIST_TESTING() == _ON)
                {
                    ...
                    {
                        if(ScalerGetBit_EXINT(P2B_35_ECBUS_BIST_CONFIG, _BIT3) == 0x00)
                        {
                            // Force PRBS BIST Mode For eCBUS Electrical CTS - Enable Mac Force Test Out (Source Skip eCBUS StartUp Flow)
                            ScalerSetBit_EXINT(P2B_52_ECBUS_TEST_FORCE_OUT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2));
                        }
                        else
                        {
                            // Force PRBS BIST Mode For eCBUS Electrical CTS - Enable Mac Force Test Out (Source Skip eCBUS StartUp Flow)
                            ScalerSetBit_EXINT(P2B_52_ECBUS_TEST_FORCE_OUT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT0));
                        }
                    }
                }
                ...
                ScalerSetBit_EXINT(P2B_01_ECBUS_STARTUP_CONFIG, ~(_BIT5 | _BIT4), (_BIT5 | _BIT4));

                // Set WD TimerEvent to Sent BWD COMMA1 12ms Later
                ScalerTimerWDActivateTimerEvent_EXINT0(12, _SCALER_WD_TIMER_EVENT_RX2_ECBUS_SEND_BWD_COMMA1);

                // Record eCBUS_INT Flow State-2 (BWD Start All 1 WD)
                ScalerSetBit_EXINT(P2B_5F_ECBUS_RESERVE_2, ~_BIT1, _BIT1);
            }
        }
        ...
        SET_D2_INPUT_PIXEL_CLK((((DWORD)_GDI_CLK_KHZ * usCount + 50000) / 100000));

#if(_D2_HDMI_2_0_SUPPORT == _ON)

        // If SCDC tell 1:40 then set High speed flag
        if((GET_D2_INPUT_PIXEL_CLK() >= 850) && (GET_D2_INPUT_PIXEL_CLK() <= 1500))
        {
        ...
        {
            SET_D2_INPUT_PIXEL_CLK((GET_D2_INPUT_PIXEL_CLK() * 4));
        }
#endif
        ...
        if((GET_TMDS_RX2_PHY_SET() == _FALSE) || ((bit)ScalerTMDSRx2CheckCDRStable_EXINT0(g_usTMDSRx2ClkCount) == _FALSE))
        {
            ...
            if(ScalerGetBit_EXINT(P71_CA_HDMI_DP, ~_BIT6) == _BIT6)
            {
                ...
                SET_TMDS_D2_OFFLINE_MEASURE_CLK(((DWORD)(_GDI_CLK_KHZ * 1024) * 2 / 100) / g_usTMDSRx2ClkCount);
            }
            else
            {
                // TMDS_OFFLine Measure FREQ(MHz) = GDI_CLK(MHz) * 1024 / g_usTMDSRx2ClkCount
                SET_TMDS_D2_OFFLINE_MEASURE_CLK(((DWORD)(_GDI_CLK_KHZ * 1024) / 100) / g_usTMDSRx2ClkCount);
            }

#if(_D2_HDMI_2_0_SUPPORT == _ON)
            if(GET_TMDS_RX2_HIGH_SPEED_MODE() == _TRUE)
            {
                SET_TMDS_D2_OFFLINE_MEASURE_CLK((GET_TMDS_D2_OFFLINE_MEASURE_CLK() * 4));
            }
#endif
            ...
            if(GET_D2_TMDS_MODE() == _TMDS_MHL_MODE)
            {
                ...
                if((GET_MHL3_RX2_ECBUS_MODE() == _ON) || (GET_MHL3_RX2_BIST_TESTING() == _ON))
                {
                    ...
                    ScalerTimerWDCancelTimerEvent_EXINT0(_SCALER_WD_TIMER_EVENT_RX2_ECBUS_CLK_UNSTABLE_TMOUT);

                    // Disable Stuck Low IRQ
                    ScalerSetBit_EXINT(P2A_A4_CBUS_CTRL_04, ~(_BIT1 | _BIT0), 0x00);
                ...
                {
                    if((GET_D2_INPUT_PIXEL_CLK() >= 730) && (GET_D2_INPUT_PIXEL_CLK() <= 770))
                    {
                        ...
                        if((ScalerTMDSRx2CheckCDRStable_EXINT0(g_usTMDSRx2ClkCount) == _FALSE) || (ScalerMHLRx2DetectClkMode_EXINT0() == _FALSE))// MHL mode need modify
                        {
                            ...
                            SET_D2_INPUT_PIXEL_CLK(GET_D2_INPUT_PIXEL_CLK() * 3);
                            ScalerTMDSRx2SetPhy_EXINT0();
                            SET_D2_INPUT_PIXEL_CLK(GET_D2_INPUT_PIXEL_CLK() / 3);
...
#endif
        {
            ...
            if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && ((GET_MHL3_RX2_ECBUS_MODE() == _ON) || (GET_MHL3_RX2_BIST_TESTING() == _ON)))
            {
                ...
                if((GET_MHL3_RX2_AV_LINK_RATE() != _ECBUS_LINK_RATE_NULL) && (GET_MHL3_RX2_AV_LINK_N_CODE() != _ECBUS_N_CODE_NULL))
                {
                    ...
                    ScalerTMDSRx2MHL3DcdrSetPhy_EXINT0();
#elif(_MHL3_ECBUS_AVLINK_CDR_MODE == _ACDR_MODE)
                    // ECBUS Data Link Set PHY
                    ScalerTMDSRx2MHL3AcdrSetPhy_EXINT0();
#endif
    ...
    if((ScalerGetByte_EXINT(P71_E6_HDMI_FREQDET_CTRL) & 0x06) == 0x06)
    {
        ...
        if((abs(g_usTMDSRx2ClkCount - ScalerTMDSRx2MeasureClk_EXINT0(_CLK_SOURCE_TMDS)) > (g_usTMDSRx2ClkCount >> 6)) ||
           (abs(GET_D2_INPUT_PIXEL_CLK() - ((GET_TMDS_D2_OFFLINE_MEASURE_CLK() << 3) / ((GET_COLOR_SPACE(_D2_INPUT_PORT) == _COLOR_SPACE_YCBCR422) ? _COLOR_DEPTH_8_BITS : GET_COLOR_DEPTH(_D2_INPUT_PORT)))) > (GET_D2_INPUT_PIXEL_CLK() >> 6)))
        {
            if((GET_TMDS_RX2_FORCE_BCKGRD_PATH() & _DISPLAY_PATH_M1) != 0)
            {
            ...
            if((GET_TMDS_RX2_FORCE_BCKGRD_PATH() & _DISPLAY_PATH_M2) != 0)
            {
            ...
            if((GET_TMDS_RX2_FORCE_BCKGRD_PATH() & _DISPLAY_PATH_S1) != 0)
            {
            ...
            if((GET_TMDS_RX2_FORCE_BCKGRD_PATH() & _DISPLAY_PATH_S2) != 0)
            {
            ...
            if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && (ScalerGetBit_EXINT(P7B_1B_CMU_01, _BIT4) == 0x00) && (GET_MHL3_RX2_ECBUS_MODE() == _ON))
            {
                // Disable MHL3 RGB/clock Output to avoid garbage
                ScalerSetBit_EXINT(P76_10_REG_MHL3_OUTPUT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
            }
            else
#endif // End of #if((_D2_INPUT_PORT_TYPE == _D2_MHL_PORT) && (_D2_MHL_VERSION >= _MHL_VERSION_3_0))
            {
            ...
            if(GET_D2_TMDS_MODE() == _TMDS_MHL_MODE)
            {
                ...
                if((GET_MHL3_RX2_ECBUS_MODE() == _ON) || (GET_MHL3_RX2_BIST_TESTING() == _ON))
                {
                    ...
                    {
                        ScalerTimerWDActivateTimerEvent_EXINT0(10, _SCALER_WD_TIMER_EVENT_RX2_ECBUS_CLK_UNSTABLE_TMOUT);
                    }
                    else
                    {
    ...
    if(((ScalerGetBit_EXINT(P71_A9_TMDS_ABC0, _BIT7) == _BIT7) && (ScalerGetBit_EXINT(P71_AA_TMDS_ABC1, _BIT4) == _BIT4)) ||
       ((ScalerGetBit_EXINT(P71_A9_TMDS_ABC0, _BIT5) == _BIT5) && (ScalerGetBit_EXINT(P71_AA_TMDS_ABC1, _BIT2) == _BIT2)))
    {
        // Disbale HDCP 1.4 IRQ
        ScalerSetBit_EXINT(P71_AA_TMDS_ABC1, ~(_BIT4 | _BIT2), 0x00);
...
BYTE ScalerTMDSRx2TMDSScanInputPort(BYTE ucInputType)
{
    ...
    if(GET_TMDS_RX2_PHY_SET() == _TRUE)
    {
        ...
        if((ScalerTMDSRx2CheckCDRStable(g_usTMDSRx2ClkCount) == _FALSE) ||
           ((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && (ScalerMHLRx2DetectClkMode() == _FALSE) && (GET_MHL3_RX2_ECBUS_MODE() == _OFF)) ||
           (ScalerTMDSRx2TMDSVideoDetect(_WAIT) == _TMDS_VIDEO_DATA_NONE))

#else // Else of #if(_D2_MHL_VERSION >= _MHL_VERSION_3_0)
        ...
        if((ScalerTMDSRx2CheckCDRStable(g_usTMDSRx2ClkCount) == _FALSE) || (ScalerTMDSRx2TMDSVideoDetect(_WAIT) == _TMDS_VIDEO_DATA_NONE))
#else
        if(ScalerTMDSRx2CheckCDRStable(g_usTMDSRx2ClkCount) == _FALSE)
#endif
        ...
        ScalerSetBit(P71_14_HDMI_CTRL_14, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (GET_D2_INPUT_PIXEL_CLK() / 10) >> 8);
        ScalerSetByte(P71_15_HDMI_CTRL_15, (GET_D2_INPUT_PIXEL_CLK() / 10));
        ...
        if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX2_ECBUS_MODE() == _ON))
        {
            ...
            if(ScalerMHL3Rx2DisplayFormatSetting() == _FALSE)
            {
#if(_MHL3_ECBUS_AVLINK_DEBUG_MESSAGE == _ON)
            ...
            ulPixelClkValue = ScalerMHL3Rx2StreamClkRegenerate();
            ...
            if(ScalerMHL3Rx2DisplayFormatGenFifoCheck() == _FALSE)
            {
                if(ScalerGetBit(P76_41_DPF_CTRL_0, _BIT4) == _BIT4)
                {
                    ScalerMHL3Rx2DisplatFormatGenAdjustHsyncDelay(ulPixelClkValue);
                }
                else
                {
                    ScalerMHL3Rx2DisplayFormatGenAdjustVsyncDelay(ulPixelClkValue);
                }
...
#endif // End of #if((_D2_INPUT_PORT_TYPE == _D2_MHL_PORT) && (_D2_MHL_VERSION >= _MHL_VERSION_3_0))
        {
            ...
            if(((GET_MHL_RX2_ADOPTER_ID_HBYTE() == _ASUS_PADFONE2_ADOPTER_ID_HBYTE) && (GET_MHL_RX2_ADOPTER_ID_LBYTE() == _ASUS_PADFONE2_ADOPTER_ID_LBYTE)) &&
               !(ScalerGetBit(P71_A9_TMDS_ABC0, (_BIT7 | _BIT6)) == (_BIT7 | _BIT6)))
            {
                return _SOURCE_NONE;
            }
#endif
        ...
        if(ucTMDSType == _SOURCE_HDMI)
        {
            ...
            SET_COLOR_DEPTH(_D2_INPUT_PORT, ScalerTMDSRx2HdmiGetColorDepth());
...
#if(_HDMI_FREESYNC_SUPPORT == _ON)
            if(ScalerTMDSRx2HdmiGetAmdSpdInfo(_SPD_INFO_FREESYNC_SUPPORT) == _ENABLE)
            {
                SET_HDMI_FREESYNC_ENABLED();

                // Get SPD Free Sync Vfreq Max
                g_usFREESYNCVFreq = (WORD)ScalerTMDSRx2HdmiGetAmdSpdInfo(_SPD_INFO_FREESYNC_MAX_VFREQ) * 10;
        ...
        if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX2_ECBUS_MODE() == _ON))
        {
            ...
            ScalerSetBit(P76_10_REG_MHL3_OUTPUT_0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
        }
        else
#endif // End of #if((_D2_INPUT_PORT_TYPE == _D2_MHL_PORT) && (_D2_MHL_VERSION >= _MHL_VERSION_3_0))
        {
...
bit ScalerTMDSRx2TMDSStableDetect(BYTE ucSourceType)
{
    ...
    if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX2_ECBUS_MODE() == _ON))
    {
        if(ScalerGetBit(P76_10_REG_MHL3_OUTPUT_0, _BIT7) == 0x00)
        {
            DebugMessageRx2("MHL3 Clock Output has been disable", ucSourceType);
            return _FALSE;
        }
    }
    else
...
#endif
    {
        ...
        if((GET_D2_TMDS_MODE() == _TMDS_MHL_MODE) && (GET_MHL3_RX2_ECBUS_MODE() == _ON))
        {
            if(GET_MHL3_RX2_MEASURE_VIEW_PIXEL_FORMAT() == _MHL3_VIDEO_24BIT_FORMAT)
            {
                if(ucSourceType == _SOURCE_HDMI)
                {
                    if(ScalerGetBit(P76_38_MHL_MEASURE_24, _BIT5) == _BIT5)
                    {
                        DebugMessageRx2("MHL3 Format Changed", ucSourceType);
                        return _FALSE;
                    }
                }
                else
                {
                    if(ScalerGetBit(P76_38_MHL_MEASURE_24, _BIT5) == 0x00)
                    {
                        DebugMessageRx2("MHL3 Format Changed", ucSourceType);
                        return _FALSE;
                    }
    ...
    {
        if((ScalerGetBit(P71_A9_TMDS_ABC0, _BIT6) == _BIT6) && (ScalerGetBit(P71_A9_TMDS_ABC0, (_BIT7 | _BIT5)) != (_BIT7 | _BIT5)))
        {
        ...
        else if((ScalerGetBit(P71_A9_TMDS_ABC0, (_BIT7 | _BIT5)) == (_BIT7 | _BIT5)))
        {
            CLR_TMDS_RX2_Z0_ASSERTED();
    ...
    if(ucSourceType == _SOURCE_HDMI)
    {
        if(GET_HDMI_RX2_PACKET_DETECTING() == _FALSE)
        {
            ...
            else
            {
                ...
                if(GET_COLOR_RGB_QUANTIZATION_RANGE(_D2_INPUT_PORT) != _RGB_QUANTIZATION_RESERVED)
                {
            ...
            {
                if((GET_COLOR_SPACE(_D2_INPUT_PORT) != _COLOR_SPACE_YCBCR422) && (ScalerTMDSRx2HdmiGetColorDepth() != GET_COLOR_DEPTH(_D2_INPUT_PORT)))
                {
                    DebugMessageRx2("Color Depth Has Changed", GET_COLOR_DEPTH(_D2_INPUT_PORT));
                    return _FALSE;
                }
            }
            else
            {
                if((GET_COLOR_SPACE(_D2_INPUT_PORT) != _COLOR_SPACE_YCBCR422) && (GET_COLOR_DEPTH(_D2_INPUT_PORT) != _COLOR_DEPTH_8_BITS))
                {
            ...
            {
                if((bit)ScalerTMDSRx2HdmiGetAmdSpdInfo(_SPD_INFO_FREESYNC_SUPPORT) != GET_HDMI_FREESYNC_ENABLED())
                {
...
#if(_HDMI_FREESYNC_SUPPORT == _ON)
        if(GET_TMDS_RX2_FREESYNC_SUPPORT() != GET_FREESYNC_SUPPORT())
        {
            SET_TMDS_RX2_FREESYNC_SUPPORT(GET_FREESYNC_SUPPORT());
            SET_TMDS_RX2_HPD_TRIGGER_EVENT(_TMDS_HPD_NORMAL);
...
void ScalerTMDSRx2HotPlugEvent(void)
{
    ...
    {
        // Save Z0 Status
        ucZ0Status = ScalerGetBit(P7B_18_IMPEDANCE_00, (_BIT7 | _BIT6 | _BIT5 | _BIT4));
        ...
        // Restore Z0 Status
        ScalerSetBit(P7B_18_IMPEDANCE_00, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), ucZ0Status);
