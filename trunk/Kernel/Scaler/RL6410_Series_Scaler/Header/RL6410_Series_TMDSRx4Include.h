...
extern void ScalerTMDSRx4MHL3SetCmu(BYTE ucCmuSel);
#endif

extern void ScalerTMDSRx4MHL3SetCmu_EXINT0(BYTE ucCmuSel);
extern void ScalerTMDSRx4MHL3SetDFEInitial(void);
extern void ScalerTMDSRx4MHL3SetDFEInitial_EXINT0(void);

#if(_MHL3_ECBUS_AVLINK_CDR_MODE == _ACDR_MODE)
extern void ScalerTMDSRx4MHL3AcdrSetPhy(void);
extern void ScalerTMDSRx4MHL3AcdrSetPhy_EXINT0(void);
#endif

#if(_MHL3_ECBUS_AVLINK_CDR_MODE == _DCDR_MODE)
extern void ScalerTMDSRx4MHL3DcdrSetPhy(void);
extern void ScalerTMDSRx4MHL3DcdrSetPhy_EXINT0(void);
#endif
