...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_Series_Mcu.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#if((_D3_INPUT_PORT_TYPE == _D3_DVI_PORT) || (_D3_INPUT_PORT_TYPE == _D3_DUAL_DVI_PORT) || (_D3_INPUT_PORT_TYPE == _D3_HDMI_PORT) || (_D3_INPUT_PORT_TYPE == _D3_MHL_PORT))
...
void ScalerMcuDdcInitial(void)
{
    ...
    ScalerSetBit(P6F_04_CBUS0_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
#elif(_D1_CBUS_CHANNEL_SEL == _CBUS1)
    ScalerSetBit(P6F_05_CBUS1_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
#elif(_D1_CBUS_CHANNEL_SEL == _CBUS2)
    ScalerSetBit(P6F_06_CBUS2_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
#elif(_D1_CBUS_CHANNEL_SEL == _CBUS3)
    ScalerSetBit(P6F_07_CBUS3_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT0);
#endif
    ...
    ScalerSetBit(P6F_04_CBUS0_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT1);
#elif(_D2_CBUS_CHANNEL_SEL == _CBUS1)
    ScalerSetBit(P6F_05_CBUS1_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT1);
#elif(_D2_CBUS_CHANNEL_SEL == _CBUS2)
    ScalerSetBit(P6F_06_CBUS2_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT1);
#elif(_D2_CBUS_CHANNEL_SEL == _CBUS3)
    ScalerSetBit(P6F_07_CBUS3_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT1);
#endif
    ...
    ScalerSetBit(P6F_04_CBUS0_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
#elif(_D3_CBUS_CHANNEL_SEL == _CBUS1)
    ScalerSetBit(P6F_05_CBUS1_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
#elif(_D3_CBUS_CHANNEL_SEL == _CBUS2)
    ScalerSetBit(P6F_06_CBUS2_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
#elif(_D3_CBUS_CHANNEL_SEL == _CBUS3)
    ScalerSetBit(P6F_07_CBUS3_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
#endif
    ...
    ScalerSetBit(P6F_04_CBUS0_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
#elif(_D4_CBUS_CHANNEL_SEL == _CBUS1)
    ScalerSetBit(P6F_05_CBUS1_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
#elif(_D4_CBUS_CHANNEL_SEL == _CBUS2)
    ScalerSetBit(P6F_06_CBUS2_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
#elif(_D4_CBUS_CHANNEL_SEL == _CBUS3)
    ScalerSetBit(P6F_07_CBUS3_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
#endif
    ...
    ScalerSetBit(P6F_04_CBUS0_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
#elif(_D5_CBUS_CHANNEL_SEL == _CBUS1)
    ScalerSetBit(P6F_05_CBUS1_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
#elif(_D5_CBUS_CHANNEL_SEL == _CBUS2)
    ScalerSetBit(P6F_06_CBUS2_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
#elif(_D5_CBUS_CHANNEL_SEL == _CBUS3)
    ScalerSetBit(P6F_07_CBUS3_MAP_DDC, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
#endif
