...
WORD ScalerVgipGetCaptureVStartPosition(void)
{
    ...
    {
        usIVstart = ((((ScalerGetByte(P0_18_M1_IPV_ACT_STA_H) & 0x0F) << 8) | ScalerGetByte(P0_19_M1_IPV_ACT_STA_L)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_M2) == _TRUE)
    {
        usIVstart = ((((ScalerGetByte(P40_18_M2_IPV_ACT_STA_H) & 0x0F) << 8) | ScalerGetByte(P40_19_M2_IPV_ACT_STA_L)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_S1) == _TRUE)
    {
        usIVstart = ((((ScalerGetByte(P80_18_S1_IPV_ACT_STA_H) & 0x0F) << 8) | ScalerGetByte(P80_19_S1_IPV_ACT_STA_L)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_S2) == _TRUE)
    {
        usIVstart = ((((ScalerGetByte(PC0_18_S2_IPV_ACT_STA_H) & 0x0F) << 8) | ScalerGetByte(PC0_19_S2_IPV_ACT_STA_L)));
    }
...
WORD ScalerVgipGetCaptureVHeight(void)
{
    ...
    if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_M1) == _TRUE)
    {
        usIVheight = ((((ScalerGetByte(P0_18_M1_IPV_ACT_STA_H) & 0xF0) << 4) | ScalerGetByte(P0_1B_M1_IPV_ACT_LEN_L)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_M2) == _TRUE)
    {
        usIVheight = ((((ScalerGetByte(P40_18_M2_IPV_ACT_STA_H) & 0xF0) << 4) | ScalerGetByte(P40_1B_M2_IPV_ACT_LEN_L)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_S1) == _TRUE)
    {
        usIVheight = ((((ScalerGetByte(P80_18_S1_IPV_ACT_STA_H) & 0xF0) << 4) | ScalerGetByte(P80_1B_S1_IPV_ACT_LEN_L)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_S2) == _TRUE)
    {
        usIVheight = ((((ScalerGetByte(PC0_18_S2_IPV_ACT_STA_H) & 0xF0) << 4) | ScalerGetByte(PC0_1B_S2_IPV_ACT_LEN_L)));
    }
...
WORD ScalerVgipGetCaptureVDelay(void)
{
    ...
    if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_M1) == _TRUE)
    {
        usIVSDelay = (((((WORD)(ScalerGetByte(P0_1E_M1_VGIP_HV_DELAY) & _BIT1)) << 7) | ScalerGetByte(P0_1C_M1_IVS_DELAY)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_M2) == _TRUE)
    {
        usIVSDelay = (((((WORD)(ScalerGetByte(P40_1E_M2_VGIP_HV_DELAY) & _BIT1)) << 7) | ScalerGetByte(P40_1C_M2_IVS_DELAY)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_S1) == _TRUE)
    {
        usIVSDelay = (((((WORD)(ScalerGetByte(P80_1E_S1_VGIP_HV_DELAY) & _BIT1)) << 7) | ScalerGetByte(P80_1C_S1_IVS_DELAY)));
    }
    else if(CHK_VGIP_INPUT_PATH(_INPUT_PATH_S2) == _TRUE)
    {
        usIVSDelay = (((((WORD)(ScalerGetByte(PC0_1E_S2_VGIP_HV_DELAY) & _BIT1)) << 7) | ScalerGetByte(PC0_1C_S2_IVS_DELAY)));
    }
