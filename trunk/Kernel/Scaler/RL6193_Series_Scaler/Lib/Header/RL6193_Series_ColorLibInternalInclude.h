...
//****************************************************************************
// 420to422
extern bit ScalerColor420to422CheckCRC(WORD usCRCAddr, EnumInputDataPath enumInputDataPath);
extern WORD ScalerColor420to422VGIPSetting(EnumInputDataPath enumInputDataPath);
