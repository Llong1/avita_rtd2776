...
void ScalerDisplayLvdsTxDataSel(void)
{
    ...
    ScalerSetByte(P39_04_LVDS_DISPLAY_CONV_CTRL3, 0x00);
    ...
    #else
    ScalerSetBit(P95_36_LVDS_PORTB_CTRL6, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    #endif
    ...
    #else
    ScalerSetBit(P95_26_LVDS_PORTA_CTRL6, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    #endif
