...
#define _A0_EMBEDDED_DDCRAM_LOCATION         _EDID_TABLE_LOCATION_USER//_EDID_TABLE_LOCATION_CODE
...
#define _D1_INPUT_PORT_TYPE                  _D1_HDMI_PORT   //   _D1_HDMI_PORT
#define _D1_DDC_CHANNEL_SEL                  _DDC1
#define _D1_EMBEDDED_DDCRAM_SIZE             _EDID_SIZE_NONE//   _EDID_SIZE_256
#define _D1_EMBEDDED_DDCRAM_LOCATION         _EDID_TABLE_LOCATION_USER//  _EDID_TABLE_LOCATION_SYSTEM_EEPROM//_EDID_TABLE_LOCATION_CODE

//--------------------------------------------------
// D2 Input Port
//--------------------------------------------------
#define _D2_INPUT_PORT_TYPE                     _D2_DVI_PORT
...
#define _LVDS_PORT_SEL                          _LVDS_1_PORT_E
#define _LVDS_PORT_MIRROR                       _DISABLE
#define _LVDS_PORT_AB_SWAP                      _DISABLE
#define _LVDS_PORT_CD_SWAP                      _DISABLE
#define _LVDS_PORT_EF_SWAP                      _DISABLE
...
#define _LVDS_CLK_CHANNEL_SEL                    _MODE_2 // EF
#endif
...
// DP33V_ON
// alant debug: ab key option
#define _PIN_AC6                            (0 & 0x07)//      (2 & 0x07) // Page 10-0x08[2:0]
// 0 ~ 6 (0: P3D0i<I>, 1: P3D0o<PP>, 2: P3D0o<OD>, 3: Test4b_out0, 4: Test4b_out1,
//        5: Test4b_out2, 6: Test4b_out3)

// DP5V_ON 
// alant debug: usb_pwr_en
#define _PIN_AC4                             (2& 0x07)//    (0 & 0x07) // Page 10-0x09[2:0]
// 0 ~ 6 (0: P3D1i<I>, 1: P3D1o<PP>, 2: P3D1o<OD>, 3: Test4b_out0, 4: Test4b_out1,
//        5: Test4b_out2, 6: Test4b_out3)

// NC
#define _PIN_AC5                                (3 & 0x07) // Page 10-0x0A[2:0]
// 0 ~ 6 (0: P3D2i<I>, 1: P3D2o<PP>, 2: P3D2o<OD>, 3: Test4b_out0, 4: Test4b_out1,
//        5: Test4b_out2, 6: Test4b_out3)

// NC
#define _PIN_AD6                                (4 & 0x07) // Page 10-0x0B[2:0]
// 0 ~ 6 (0: P3D3i<I>, 1: P3D3o<PP>, 2: P3D3o<OD>, 3: Test4b_out0, 4: Test4b_out1,
//        5: Test4b_out2, 6: Test4b_out3)

// NC (Mstar)  // signal status
#define _PIN_AD5                                (1 & 0x07)//  (0 & 0x07) // Page 10-0x0C[2:0]
...
// NC
#define _PIN_AE5                                (5 & 0x07) // Page 10-0x0E[2:0]
...
// NC (Panel_PWM)
#define _PIN_AK2                               (1 & 0x07) //(0 & 0x07) // Page 10-0x1B[2:0]
...
// VBUS_EN_2
// audio_det
#define _PIN_AD29                           (0 & 0x07)//      (1 & 0x07) // Page 10-0x3C[2:0]
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                       (P3_5) // Pin_AE6, P3.5  ///(MCU_FE0B_PORT53_PIN_REG) // Pin_AK2, P5.3
...
#define bEDID_WRITE_PROTECT                    MCU_FE2B_PORT93_PIN_REG // ) // Pin_AF28
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // Pin_AH28, PA.3
#define bD0_DP_PIN16_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // Pin_AH27, PA.5
#define bD0_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // Pin_AE29, PA.4

#define bA0_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE07_PORT47_PIN_REG) // Pin_AJ2, P4.7
...
#define bD3_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// Pin_AC29, PB.2
#define bD4_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// Pin_AH26, PB.1
#define bD5_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// Pin_AD28, PB.0
...
//-----------------------------------------------
#define bD2_MHL_CONNECT                      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//   (P1_5) // Pin_Y7, P1.5
#define bD3_MHL_CONNECT                      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//   (P1_7) // Pin_Y6, P1.7
#define bD4_MHL_CONNECT                      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//   (MCU_FE5C_PORTF4_PIN_REG) // Pin_N5, PF.4
#define bD5_MHL_CONNECT                      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//   (MCU_FE5A_PORTF2_PIN_REG) // Pin_N6, PF.2
...
//-----------------------------------------------
#define bD0_HPD                              (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//   (MCU_FE4C_PORTD4_PIN_REG) // Pin_AH4, PD.4
#define bD1_HPD                                 (MCU_FE4B_PORTD3_PIN_REG) // Pin_AH3, PD.3
#define bD2_HPD                                 (P1_4) // Pin_AB5, P1.4
#define bD3_HPD                                (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// (P1_6) // Pin_AB4, P1.6
#define bD4_HPD                                (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// (MCU_FE5B_PORTF3_PIN_REG) // Pin_A4, PF.3
#define bD5_HPD                                (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// (MCU_FE59_PORTF1_PIN_REG) // Pin_A3, PF.1
...
#define bAudioDetect                          MCU_FE2C_PORT94_PIN_REG// Pin_AD29
...
// signal status
#define bSignal  (P3_4) // Pin_AD5, P3.4

#define PCB_SIGNAL_STATUS(x)                         {\
                                                    bSignal = (x);\
                                                }


//////////
// customized key define
//////////
#define bIRoption                                  (P3_0) // Pin_AC6, P3.0
#define bUSBpower                                   (P3_1) // Pin_AC4, P3.1
