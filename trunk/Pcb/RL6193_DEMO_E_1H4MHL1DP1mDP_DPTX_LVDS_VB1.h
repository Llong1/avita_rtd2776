...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_DEMO_E_1H4MHL1DP1mDP_DPTX_LVDS_VB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6193_DEMO_E_1H4MHL1DP1mDP_DPTX_LVDS_VB1)
...
// D6 Input Port
//--------------------------------------------------
#define _D6_INPUT_PORT_TYPE                     _D6_DP_PORT
#define _D6_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_256
#define _D6_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_USER
...
#define _D6_INPUT_PORT_SWITCH_FROM              _SWITCH_FROM_D0
...
#define _D6_INPUT_PORT_GROUP                    _INPUT_PORT_GROUP_0
...
#define _INPUT_PORT_SEARCH_PRI_5                _D5_INPUT_PORT
#define _INPUT_PORT_SEARCH_PRI_6                _D6_INPUT_PORT
...
// DP33V_ON_0
#define _PIN_AC5                                (2 & 0x07) // Page 10-0x0A[2:0]
...
// AUX_HPD_SEL
#define _PIN_AD5                                (2 & 0x07) // Page 10-0x0C[2:0]
...
// GPU_SEL
#define _PIN_AE4                                (2 & 0x07) // Page 10-0x0F[2:0]
// 0 ~ 6 (0: P3D7i<I>, 1: P3D7o<PP>, 2: P3D7o<OD>, 3: Test4b_out0, 4: Test4b_out1,
//        5: Test4b_out2, 6: Test4b_out3)

// DP_SW_OE
#define _PIN_AF4                                (2 & 0x07) // Page 10-0x10[2:0]
...
// EDID_WP
#define _PIN_AG28                               (1 & 0x0F) // Page 10-0x41[2:0]
...
#define bD6_DP_PIN15_CONNECT                    (MCU_FE36_PORTA6_PIN_REG) // Pin_AB28, PA.6
#define bD6_DP_PIN16_CONNECT                    (P3_6) // Pin_AE5, P3.6
#define bD6_DP_PIN17_CONNECT                    (MCU_FE37_PORTA7_PIN_REG) // Pin_AH25, PA.7
...
#define GET_PCB_D6_DP_SOURCE_POWER()            (bD0_DP_PIN17_CONNECT)
...
//-----------------------------------------------
#define bDIGITAL_D6_SWITCH_POWER                (MCU_FE00_PORT40_PIN_REG) // Pin_AF4, P4.0
...
//-----------------------------------------------
#define bDIGITAL_D6_SWITCH_LANE                 (P3_7) // Pin_AE4, P3.7
#define bDIGITAL_D6_SWITCH_AUX_HPD              (P3_4) // Pin_AD5, P3.4
...
#endif // End of #if(_PCB_TYPE == _RL6193_DEMO_E_1H4MHL1DP1mDP_DPTX_LVDS_VB1)
