...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6410_DEMO_TC_3MHL1DP1TYPEC_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6410_DEMO_TC_3MHL1DP1TYPEC_DPTX_LVDS_eDP)
...
#define _D0_DP_SMBUS_IIC                        _HW_IIC_PIN_AD28_AH27
...
#define bD0_CONNECT                             ((((bit)bD0_USB_TYPEC_AUXP_CONNECT == _TRUE) && ((bit)bD0_USB_TYPEC_AUXN_CONNECT == _FALSE)) && (SysDpTypeCGetD0AltModeCheck() == _TRUE))
...
#endif // End of #if(_PCB_TYPE == _RL6410_DEMO_TC_3MHL1DP1TYPEC_DPTX_LVDS_eDP)
