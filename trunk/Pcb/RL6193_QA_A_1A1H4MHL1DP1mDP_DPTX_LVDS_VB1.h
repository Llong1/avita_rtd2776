...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_QA_A_1A1H4MHL1DP1mDP_DPTX_LVDS_VB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6193_QA_A_1A1H4MHL1DP1mDP_DPTX_LVDS_VB1)
...
#define _INPUT_PORT_SEARCH_PRI_7                _D6_INPUT_PORT
...
// AUX_HPD_SEL
#define _PIN_AF4                                (1 & 0x07) // Page 10-0x10[2:0]
...
// SPDIF0
#define _PIN_R29                                (3 & 0x07) // Page 10-0x2F[2:0]
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    (MCU_FE36_PORTA6_PIN_REG)   // Pin_AB28, PA.6
#define bD0_DP_PIN16_CONNECT                    (P3_7)                   // Pin_AE4, P3.7
#define bD0_DP_PIN17_CONNECT                    (MCU_FE37_PORTA7_PIN_REG)   // Pin_AH25, PA.7

#define bD6_DP_PIN15_CONNECT                    (MCU_FE33_PORTA3_PIN_REG)  // Pin_AH28, PA.3
#define bD6_DP_PIN16_CONNECT                    (MCU_FE35_PORTA5_PIN_REG)  // Pin_AH27, PA.5
#define bD6_DP_PIN17_CONNECT                    (MCU_FE34_PORTA4_PIN_REG)  // Pin_AE29, PA.4
...
//-----------------------------------------------
#define bDIGITAL_D6_SWITCH_POWER                (P3_6) // Pin_AE5, P3.6
...
//-----------------------------------------------
#define bDIGITAL_D6_SWITCH_LANE                 (P3_5) // Pin_AE6, P3.5
#define bDIGITAL_D6_SWITCH_AUX_HPD              (MCU_FE00_PORT40_PIN_REG) // Pin_AF4, P4.0
...
#endif // End of #if(_PCB_TYPE == _RL6193_QA_A_1A1H4MHL1DP1mDP_DPTX_LVDS_VB1)
