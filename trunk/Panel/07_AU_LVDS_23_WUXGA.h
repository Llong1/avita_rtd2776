...
#define _PANEL_MIN_FRAME_RATE                   460///560
...
#define _PANEL_DH_TOTAL                        2120/// 2080                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                   2300///  2200                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                    2048/// 2000                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         6                   // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                       1080/// 1200                // Display Vertical Width
#define _PANEL_DV_END                          1086/// 1216                // Display Vertical End Position

#define _PANEL_DV_TOTAL                        1125/// 1250                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                    1600/// 2048                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                    1088/// 1211                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                     148/// 190                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                 230/// 200                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                 110/// 100                 // Mininum Pixel Clock in MHz

#define _PANEL_POWER_ON_T1                     100/// 20                  // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      40                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                     1100/// 250                 // Panel Power On T3 (ms)

#define _PANEL_POWER_OFF_T4                     20                  // Panel Power Off T4 (ms)
#define _PANEL_POWER_OFF_T5                     1/// 40                  // Panel Power Off T5 (ms)
