...
#define _PANEL_DH_TOTAL                       2120/// 2200//  2100                // Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MIN                     1088/// 1100                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                    150/// 148//  144                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  230                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  110                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      100            //ps on     // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      40/// 120 //40             //lvds delay     // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                    1100//  300      // bl delay           // Panel Power On T3 (ms)

#define _PANEL_POWER_OFF_T4                     20         // bl off         // Panel Power Off T4 (ms)
#define _PANEL_POWER_OFF_T5                    1// 40          // lvds off        // Panel Power Off T5 (ms)
