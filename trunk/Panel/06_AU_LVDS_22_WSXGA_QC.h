...
#define _PANEL_DH_END                           1728                // Display Horizontal End Position

#define _PANEL_DH_TOTAL                         2700                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     3024                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      220                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  240                 // Maxinum Pixel Clock in MHz
