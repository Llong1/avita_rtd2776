...
#include "./GAMMA/Gamma18_Samsung55.h"
#elif(_PANEL_TYPE == _AU_LVDS_24_WUXGA)
#include "./GAMMA/Gamma18_LG55.h"
#elif(_PANEL_TYPE == _AU_LVDS_23_WUXGA)
#include "./GAMMA/Gamma18_AUO32.h"
#else
...
{
#if(_PANEL_TYPE == _AU_LVDS_21_5_WUXGA)
#include "./GAMMA/Gamma20_Samsung55.h"
#elif(_PANEL_TYPE == _AU_LVDS_24_WUXGA)
#include "./GAMMA/Gamma20_LG55.h"
#elif(_PANEL_TYPE == _AU_LVDS_23_WUXGA)
#include "./GAMMA/Gamma20_AUO32.h"
#else
...
{
#if(_PANEL_TYPE == _AU_LVDS_21_5_WUXGA)
#include "./GAMMA/Gamma22_Samsung55.h"
#elif(_PANEL_TYPE == _AU_LVDS_24_WUXGA)
#include "./GAMMA/Gamma22_LG55.h"
#elif(_PANEL_TYPE == _AU_LVDS_23_WUXGA)
#include "./GAMMA/Gamma22_AUO32.h"
#else
...
{
#if(_PANEL_TYPE == _AU_LVDS_21_5_WUXGA)
#include "./GAMMA/Gamma24_Samsung55.h"
#elif(_PANEL_TYPE == _AU_LVDS_24_WUXGA)
#include "./GAMMA/Gamma24_LG55.h"
#elif(_PANEL_TYPE == _AU_LVDS_23_WUXGA)
#include "./GAMMA/Gamma24_AUO32.h"
#else
