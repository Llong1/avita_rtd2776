...
// #if 1  
     ...
     //     OsdDispMainMenuIconString((ucUpDown + 0), _ICON_DISPLAYMODE, _CP_GRAY);
// #else
...
// #endif
       ...
       //     {
                OsdDispMainMenuIconString((ucUpDown + 0), _ICON_DISPLAYFUNCTION, pucOsdItemColor[0]);
       //     }
       //     else
       //     {
       //         OsdDispMainMenuIconString((ucUpDown +0), _ICON_DISPLAYFUNCTION, _CP_GRAY);
        //    }
    ...
    //        }
            OsdDispMainMenuIconString((ucUpDown + 1), _ICON_PICTURE, pucOsdItemColor[1]);
        ...
        case _ICON_PAGE_MAIN_1:
 //#if 1   //debug
//             OsdDispMainMenuIconString((ucUpDown + 0), _ICON_ANALOG, _CP_GRAY);
// #else
...
// #endif
   ...
   //         OsdDispMainMenuIconString((ucUpDown + 2), _ICON_ADVANCE, pucOsdItemColor[2]);
            ...
            OsdDispMainMenuIconString((ucUpDown + 3), _ICON_AUDIO,  pucOsdItemColor[3]);
#else
             OsdDispMainMenuIconString((ucUpDown + 3), _ICON_NONE, pucOsdItemColor[3]); 
#endif
            break;
...
//#else
//  OsdDispMainMenuIconString((ucUpDown + 0), _ICON_AUDIO, _CP_GRAY);
//#endif
//            OsdDispMainMenuIconString((ucUpDown + 1), _ICON_OTHER, pucOsdItemColor[1]);
//            OsdDispMainMenuIconString((ucUpDown + 2), _ICON_INFORMATION, pucOsdItemColor[2]);
 //           OsdDispMainMenuIconString((ucUpDown + 3), _ICON_NONE, pucOsdItemColor[3]); //      OsdDispMainMenuIconString((ucUpDown + 3), _ICON_FACTORY, pucOsdItemColor[3]);
        ...
        case _ICON_PAGE_DISPLAYFUNCTION:
            if(GET_OSD_DISPLAY_MODE() == _OSD_DM_1P)
            {
             ...
             OsdDispMainMenuIconString((ucUpDown + 1), _ICON_NONE, pucOsdItemColor[1]);//   OsdDispMainMenuIconString((ucUpDown + 1), _ICON_LANTENCY, pucOsdItemColor[1]);

#if(_FREEZE_SUPPORT == _ON)
                OsdDispMainMenuIconString((ucUpDown + 2), _ICON_FREEZE, pucOsdItemColor[2]);
#else
               OsdDispMainMenuIconString((ucUpDown + 2), _ICON_NONE, pucOsdItemColor[2]);//  OsdDispMainMenuIconString((ucUpDown + 2), _ICON_FREEZE, _CP_GRAY);
#endif
...
#endif
//#if 0
 //          OsdDispMainMenuIconString((ucUpDown + 0), _ICON_PANEL_UNIFORMITY, _CP_GRAY);
//#else
            OsdDispMainMenuIconString((ucUpDown + 0), _ICON_GAMMA, pucOsdItemColor[0]);
//#endif
...
//#if(_CONTRAST_SUPPORT == _ON)
            OsdDispMainMenuIconString((ucUpDown + 1), _ICON_COLOR_TEMPERATURE, pucOsdItemColor[1]);
//#else
      //    OsdDispMainMenuIconString((ucUpDown + 2), _ICON_COLOR_TEMPERATURE, _CP_GRAY);
//#endif
            OsdDispMainMenuIconString((ucUpDown + 2), _ICON_COLOR_EFFECT,  pucOsdItemColor[2]);
      //      OsdDispMainMenuIconString((ucUpDown + 3), _ICON_COLOR_DEMO,  pucOsdItemColor[3]);
...
//#endif
               ...
               (GET_OSD_HLWIN_TYPE() == _HL_WIN_OFF))
            {
                ...
                {
              OsdDispMainMenuIconString((ucUpDown + 0), _ICON_COLOR_FORMAT, pucOsdItemColor[0]);//      OsdDispMainMenuIconString((ucUpDown + 1), _ICON_COLOR_FORMAT, pucOsdItemColor[1]);
                }
                else
#endif
                {
                    OsdDispMainMenuIconString((ucUpDown + 0), _ICON_COLOR_FORMAT, _CP_GRAY);
                }
            }
            else
            {
...
#endif
     //       OsdDispMainMenuIconString((ucUpDown + 0), _ICON_HUE,  pucOsdItemColor[1]);
...
//            pucOsdItemColor[1] = _CP_GRAY;
//#endif
           OsdDispMainMenuIconString((ucUpDown + 1), _ICON_DDCCI, pucOsdItemColor[1]);
        ...
        case _ICON_PAGE_INPUT_0:
#if(_MODEL_TYPE == _YLI55161)	            
           OsdDispMainMenuIconString((ucUpDown + 0), _ICON_NONE, pucOsdItemColor[0]);//   OsdDispMainMenuIconString((ucUpDown + 0), _ICON_A0_PORT, pucOsdItemColor[0]);
...
#else
           OsdDispMainMenuIconString((ucUpDown + 0), _ICON_NONE, pucOsdItemColor[0]);//   OsdDispMainMenuIconString((ucUpDown + 0), _ICON_A0_PORT, pucOsdItemColor[0]);
           OsdDispMainMenuIconString((ucUpDown + 1), _ICON_NONE, pucOsdItemColor[1]);//  OsdDispMainMenuIconString((ucUpDown + 1), _ICON_D0_PORT, pucOsdItemColor[1]);
           OsdDispMainMenuIconString((ucUpDown + 2), _ICON_D1_PORT, pucOsdItemColor[2]);
           OsdDispMainMenuIconString((ucUpDown + 3), _ICON_NONE, pucOsdItemColor[3]);
#endif
             break;
        ...
        case _ICON_PAGE_INPUT_2:
            ...
            if(GET_OSD_DISPLAY_MODE() == _OSD_DM_1P)
            {
              OsdDispMainMenuIconString((ucUpDown + 0), _ICON_NONE,  pucOsdItemColor[0]);//OsdDispMainMenuIconString((ucUpDown + 0), _ICON_D7_PORT, pucOsdItemColor[0]);
                OsdDispMainMenuIconString((ucUpDown + 1), _ICON_INPUT_AUTO, pucOsdItemColor[1]);
                OsdDispMainMenuIconString((ucUpDown + 2), _ICON_D1_PORT, pucOsdItemColor[2]);
                OsdDispMainMenuIconString((ucUpDown + 3), _ICON_D2_PORT, pucOsdItemColor[3]);
            }
        ...
        case _ICON_PAGE_AUDIO_0:
#if 1            
            OsdDispMainMenuIconString((ucUpDown + 0), _ICON_AUDIO_SOURCE, pucOsdItemColor[0]);
            OsdDispMainMenuIconString((ucUpDown + 1), _ICON_VOLUME, pucOsdItemColor[1]);
            OsdDispMainMenuIconString((ucUpDown + 2), _ICON_NONE, pucOsdItemColor[2]);
            OsdDispMainMenuIconString((ucUpDown + 3), _ICON_NONE, pucOsdItemColor[3]);
#else               
        ...
        case _ICON_PAGE_OTHER_1:
            ...
            OsdDispMainMenuIconString((ucUpDown + 3), _ICON_BORDER_WIDTH, pucOsdItemColor[3]);// used for usb power
            break;
        ...
        case _ICON_PAGE_AUDIO_SOURCE_0:
            ///Wesley_OSD Audio Analog Japan Picture_20180107
            if(GET_OSD_LANGUAGE() == _JAPAN)
              OsdDispMainOptionIcon((ucUpDown + 0), _ICON_AUDIO_ANALOG_JAPAN, pucOsdItemColor[0]);
            else
...
//#else// alant : modify
//            OsdDispMainOptionIcon((ucUpDown + 3), _ICON_NONE, pucOsdItemColor[3]);//OsdDispMainOptionIcon((ucUpDown + 3), _ICON_180_DEGREE, _CP_GRAY);
//#endif
            break;
...
#endif
////////////////////////////////////////////////////////////////////////////////////
#if(_MODEL_TYPE == _YLI55161)	// alant debug  
...
void OsdDispMainMenuOptionSetting(BYTE ucItem, BYTE ucSelectState, BYTE ucOption)
{
    ...
    switch(ucItem)
    {
        ...
        case _OPTION_USBPOWER_ONOFF: // alant test
                  ...
                  if(GET_OSD_STATE() == _MENU_OTHER_LANGUAGE_ADJUST)
                         {
                             ...
                             {
                                 OsdDispMainMenuArrow(_DOWN, _LEFT, _OSD_REJECT);
                                 OsdDispMainMenuArrow(_DOWN, _RIGHT,_OSD_REJECT);// _OSD_UNSELECT);
                             }
                 }
                OsdWindowDrawingByFontHighlight(ucWin, ucRow, ucCol, WIDTH(10), HEIGHT(5), ucWinColor, ucForegroundColor, _CP_BG);          
...
void OsdDispMainMenuCursor(WORD usOsdState, WORD usOsdStatePrevious, bit bInSubsidiary)
{
    ...
    if((usOsdCount >= _MENU_DISPLAYFUNCTION) && (usOsdCount < _MENU_ANALOG))// if((usOsdCount >= _MENU_DISPLAYMODE) && (usOsdCount <= _MENU_FACTORY))
    {
        usItem = usOsdCount - _MENU_DISPLAYFUNCTION;
        usAmount = (_MENU_ANALOG - _MENU_DISPLAYFUNCTION );//(_MENU_FACTORY - _MENU_DISPLAYMODE + 1);
    }
#else

    if((usOsdCount >= _MENU_DISPLAYFUNCTION) && (usOsdCount < _MENU_AUDIO))// if((usOsdCount >= _MENU_DISPLAYMODE) && (usOsdCount <= _MENU_FACTORY))
    {
        usItem = usOsdCount - _MENU_DISPLAYFUNCTION;
        usAmount = (_MENU_AUDIO - _MENU_DISPLAYFUNCTION );
 	}
#endif
    ...
    else if((usOsdCount >= _MENU_DISPLAYFUN_DISP_ROTATE) && (usOsdCount <= _MENU_DISPLAYFUN_FREEZE))
    {
        ...
        usAmount =1; //(_MENU_DISPLAYFUN_FREEZE - _MENU_DISPLAYFUN_DISP_ROTATE + 1);
    }
    ...
    else if((usOsdCount >= _MENU_ANALOG_AUTO) && (usOsdCount <= _MENU_ANALOG_PHASE))
    {
      ...
      else if((usOsdCount >= _MENU_COLOR_GAMMA) && (usOsdCount <= _MENU_COLOR_SATURATION))
    {
        usItem = usOsdCount - _MENU_COLOR_GAMMA;
        usAmount = (_MENU_COLOR_SATURATION - _MENU_COLOR_GAMMA + 1);
    }
...
#else
    else if((usOsdCount >= _MENU_ADVANCE_ASPECT) && (usOsdCount <=_MENU_ADVANCE_DDCCI))// _MENU_ADVANCE_HDR))
    {
        usItem = usOsdCount - _MENU_ADVANCE_ASPECT;
...
#else
    else if((usOsdCount >= _MENU_ADVANCE_ASPECT) && (usOsdCount  <=_MENU_ADVANCE_DDCCI ))// _MENU_ADVANCE_DP_LANE_COUNT))
    {
        usItem = usOsdCount - _MENU_ADVANCE_ASPECT;
        usAmount =(_MENU_ADVANCE_DDCCI - _MENU_ADVANCE_ASPECT + 1);// (_MENU_ADVANCE_DP_LANE_COUNT - _MENU_ADVANCE_ASPECT + 1);
    }
#endif
...
#if 1    
    else if((usOsdCount >= _MENU_AUDIO_AUDIO_SOURCE) && (usOsdCount <= _MENU_AUDIO_VOLUME))
    {
        usItem = usOsdCount - _MENU_AUDIO_AUDIO_SOURCE;
        usAmount =(_MENU_AUDIO_VOLUME - _MENU_AUDIO_AUDIO_SOURCE + 1);
    }
...
#if 1// alant debug
    else if((usOsdCount >= _MENU_OTHER_RESET) && (usOsdCount <= _MENU_OTHER_BORDER_WIDTH))
    {
        usItem = usOsdCount - _MENU_OTHER_RESET;
        usAmount = (_MENU_OTHER_BORDER_WIDTH - _MENU_OTHER_RESET + 1);
    }
...
#if 1   
    if(GET_OSD_STATE() == _MENU_DISPLAYFUNCTION)
    {
...
void OsdDispSliderAndNumber(WORD usOsdState, WORD usValue)
{
    ...
    switch(usOsdState)
    {
...
#if 1// alant debug
            SET_USB_POWER_STATUS(OsdDisplayDetOverRange(GET_USB_POWER_STATUS(), _ON, _OFF, _ON));
            OsdDispMainMenuOptionSetting(_OPTION_USBPOWER_ONOFF, _UNSELECT, GET_USB_POWER_STATUS());
#else
            OsdPropShowNumber(ROW(_OSD_NUMBER_1_ROW), COL(_OSD_NUMBER_1_COL), g_usAdjustValue, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_PAGE_ITEM_1, _OSD_NUMBER_UNSTLECT_COLOR);
...
#if(_MODEL_TYPE == _YLI55161)
            SET_OSD_DISP_ROTATE(OsdDisplayDetOverRange(GET_OSD_DISP_ROTATE(), _DISP_ROTATE_90, _DISP_ROTATE_0, _OFF));
        ...
        DebugMessageIR("menu timer",g_usAdjustValue);
        ...
        case _MENU_OTHER_LANGUAGE_ADJUST:
                   ...
                   g_usAdjustValue =OsdDisplayDetOverRange(g_usAdjustValue, _JAPAN, _ENGLISH,  _OFF);// OsdDisplayDetOverRange(g_usAdjustValue, _KOREA, _ENGLISH, _OFF);
...
#else
            g_usAdjustValue = OsdDisplayDetOverRange(GET_OSD_STATUS(), _OSD_ROTATE_DEGREE_270, _OSD_ROTATE_DEGREE_0, _OFF);
#endif
        ...
        case _MENU_OTHER_BORDER_WIDTH_ADJUST:// alant :usb power
#if 1   // alant debug
            SET_USB_POWER_STATUS(OsdDisplayDetOverRange(GET_USB_POWER_STATUS(), _ON, _OFF, _ON));
            OsdDispMainMenuOptionSetting(_OPTION_USBPOWER_ONOFF, _SELECT,  GET_USB_POWER_STATUS());
#else
...
// alant debug
	BYTE u1min = GET_PANEL_TIME_MIN();
	WORD u2hour = GET_PANEL_TIME_HOUR();

	BYTE u1picrot = GET_OSD_DISP_ROTATE();
	BYTE u1osdrot = GET_OSD_ROTATE_STATUS();

       BYTE BLOffset = GET_BL_OFFSET(); ///Wesley_Keep BL Offset_20180107


 //   BYTE u1input = GET_OSD_1P_INPUT_SOURCE();
    
//     DebugMessageIR("INPUT",GET_OSD_1P_INPUT_SOURCE());  
...
//SET_OSD_1P_INPUT_SOURCE(u1input); // keep input source
...
//    RTDNVRamLoadColorSetting(GET_OSD_SELECT_REGION());
    ...
    RTDNVRamRestoreOsdInputPortData(); // alant debug

       SET_FACTORY_BURNIN(_OFF);// alant debug
	SET_PANEL_TIME_MIN(u1min);
	SET_PANEL_TIME_HOUR(u2hour);

	SET_OSD_DISP_ROTATE(u1picrot);// alant: keep original value
	SET_OSD_ROTATE_STATUS(u1osdrot);

       SET_BL_OFFSET(BLOffset);  ///Wesley_Keep BL Offset_20180107
       ...
       switch(GET_OSD_ROTATE_STATUS())
       {
              default:
                   ...
                   SET_OSD_STATUS(_OSD_ROTATE_DEGREE_0);
               break;

               case _OSD_ROTATE_DEGREE_90:
                     SET_OSD_STATUS(_OSD_ROTATE_DEGREE_270);
                break;

                 case _OSD_ROTATE_DEGREE_270:
                     SET_OSD_STATUS(_OSD_ROTATE_DEGREE_90);
                 break;
       }
   ...
   //  SET_OSD_1P_INPUT_SOURCE(u1input); // keep input source
   //  DebugMessageIR("INPUT",GET_OSD_1P_INPUT_SOURCE());  
    UserAdjustRegionInputPort(_DISPLAY_RGN_1P, GET_OSD_1P_INPUT_SOURCE());
...
void OsdDispShowLogo(void)
{
    ...
    OsdDispSetPosition(_POS_PERCENT, _OSD_POSITION_GLOBAL_A, 50, 50);
#if 1  // logo on/off  ///Wesley_20180120
    OsdWindowDrawing(_OSD_WINDOW_0, XSTART(1), YSTART(1), XEND(_LOGO_WINDOW_SIZE_X), YEND(_LOGO_WINDOW_SIZE_Y), _LOGO_CP_BG);//_LOGO_CP_BLUE);
#else
