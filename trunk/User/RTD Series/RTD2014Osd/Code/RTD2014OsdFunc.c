    ...
    do
    {
        switch(GET_KEYMESSAGE())
        {
            ...
            case _RIGHT_KEY_MESSAGE:
                ...
                {
                    ucOsdInputNum =_OSD_INPUT_D1;//_OSD_INPUT_D1;// _OSD_INPUT_A0;
                }
#else
            ...
            case _LEFT_KEY_MESSAGE:
                ...
                if (ucOsdInputNum <= _OSD_INPUT_D1)//_OSD_INPUT_A0)
                {
                    ucOsdInputNum =_OSD_INPUT_AUTO; //_OSD_INPUT_D2;//_OSD_INPUT_AUTO;
                }
#else
                if (ucOsdInputNum <= _OSD_INPUT_D1)//_OSD_INPUT_A0)
                {
                    ucOsdInputNum =_OSD_INPUT_D2;//_OSD_INPUT_AUTO;
                }
        ...
        switch(ucOsdInputNum)
        {
           ...
           case _OSD_INPUT_D0://
               ...
               break;
            case _OSD_INPUT_D1:	// hdmi
                ucCheckloop =  (_D1_INPUT_TYPE - _OPTION_ICON_END);//(_D1_INPUT_TYPE - _OPTION_ICON_END);
                break;
            case _OSD_INPUT_D2:	   // dvi
