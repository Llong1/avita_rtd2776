...
// EDID Table
//--------------------------------------------------
#if((_WRITE_EDID_TO_SYSTEM_EEPROM == _ON) || ((_D2_EMBEDDED_DDCRAM_SIZE != _EDID_SIZE_NONE) && (_D2_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_CODE)))
...
#elif(_EDID_D2_TYPE_SEL == _EDID_HDMI2_3840_2160_60HZ_WITH_HFVSDB_NO_420_HDR)
