...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_Series_FormatConversionInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
typedef enum
{
    _FC_SOURCE_SST_D0 = 0x00,
    _FC_SOURCE_SST_D1 = _BIT0,
    _FC_SOURCE_V8 = _BIT1,
    _FC_SOURCE_ADC = (_BIT1 | _BIT0),
    _FC_SOURCE_D0 = _BIT2,
    _FC_SOURCE_D1 = (_BIT2 | _BIT0),
    _FC_SOURCE_D2 = (_BIT2 | _BIT1),
    _FC_SOURCE_D3 = (_BIT2 | _BIT1 | _BIT0),
    _FC_SOURCE_D4 = _BIT3,
    _FC_SOURCE_D5 = (_BIT3 | _BIT0),
...
extern void ScalerFmtCnv420To422D0InitialSetting(void);
extern bit ScalerFmtCnv420To422D0GetStatus(void);
#endif

#if(_D1_HDMI_2_0_SUPPORT == _ON)
extern void ScalerFmtCnv420To422D1InitialSetting(void);
extern bit ScalerFmtCnv420To422D1GetStatus(void);
#endif
