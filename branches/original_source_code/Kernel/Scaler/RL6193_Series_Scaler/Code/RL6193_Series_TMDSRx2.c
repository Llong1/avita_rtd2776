...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_Series_TMDSRx2.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
void ScalerTMDSRx2InterruptInitial(void)
{
    ...
    ScalerSetBit(PB1_A1_CMU_01, ~_BIT7, _BIT7);
    ...
    ScalerSetBit(P71_F6_HDMI_FREQDET_BOUND_H, ~(_BIT1 | _BIT0), 0x00);
...
void ScalerTMDSRx2SetDFEInitial_EXINT0(void) using 1
{
    ...
    ScalerSetBit_EXINT(P7B_A0_L0_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6));
    ScalerSetBit_EXINT(P7B_B0_L1_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6));
    ScalerSetBit_EXINT(P7B_C0_L2_DFE_EN_1, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT7 | _BIT6));
    ...
    ScalerSetBit_EXINT(P7B_F8_GRAY_DEC_2, ~(_BIT5 | _BIT4), _BIT4);
...
void ScalerTMDSRx2SetPhy_EXINT0(void) using 1
{
    ...
    ScalerSetBit_EXINT(PB1_A7_CMU_07, ~_BIT7, 0x00);

    // [3:0] cdr_en = 4'b0000 --> Disable CDREN
    ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);

    if(ScalerGetBit_EXINT(PB1_A0_CMU_00, _BIT6) == _BIT6)  // MHL Mode
    {
        // [7:4] rx_en = 4'b1001 --> Enable RXEN for Lane0, 3
        ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT4));

        // [5] sel_iblpf = 1 --> Enable Local Bias LPF
        ScalerSetBit_EXINT(PB1_A7_CMU_07, ~_BIT5, _BIT5);

        // [3:0] cdr_en = 4'b0001 --> Enable CDREX for Lane0
        ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
    }
    else
    {
        // [7:4] rx_en = 4'b1111 --> Enable RXEN
        ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT6 | _BIT5 | _BIT4));
        ...
        ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT0);
        ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
        ScalerSetBit_EXINT(PB1_A1_CMU_01, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT1 | _BIT0));
    }
    ...
    if(ScalerGetBit_EXINT(PB1_A0_CMU_00, _BIT6) == _BIT6)   // MHL Mode
    {
        ...
        if(GET_TMDS_RX2_CLK_MODE() == _TMDS_MHL_PPMODE_PHY_SETTING)
        {
            if(GET_D2_INPUT_PIXEL_CLK() <= 3000)
            {
                ...
                ScalerSetBit_EXINT(PB1_DB_ST_0, ~(_BIT7 | _BIT6 | _BIT5), _BIT5);

                // [7:5] SEL_DIV = 3'b001 --> 2250MHz ~ 3000MHz
                ScalerSetBit_EXINT(PB1_A3_CMU_03, ~(_BIT7 | _BIT6 | _BIT5), _BIT5);

                // [0] en_wide_temp = 1'b1
                ScalerSetBit_EXINT(PB1_AB_CDR_02, ~_BIT0, _BIT0);
                ...
                ScalerSetBit_EXINT(PB1_F9_LANE0_A_CDR_03, ~(_BIT6 | _BIT5 | _BIT4), _BIT4);

                // Analog CDR Auto FLD Counter
                ScalerSetByte_EXINT(PB1_FA_LANE0_A_CDR_04, 0xEF);
                ScalerSetByte_EXINT(PB1_FB_LANE0_A_CDR_05, 0x1D);
                ScalerSetByte_EXINT(PB1_FC_LANE0_A_CDR_06, 0xC5);

                // [4:2] reg_sel_cdr_res = 3'b010 --> Analog CDR Rs = 2K
                ScalerSetBit_EXINT(PB1_FD_LANE0_A_CDR_07, ~(_BIT4 | _BIT3 | _BIT2), _BIT3);

                // [3:0] reg_cdr_cp_in = 4'b0011 --> Analog CDR Icp = 10.5uA
                ScalerSetBit_EXINT(PB1_FE_LANE0_A_CDR_08, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
            }
            else
            {
                // [7:5] rate_sel = 3'b000 --> 3000MHz ~ 6000MHz
                ScalerSetBit_EXINT(PB1_DB_ST_0, ~(_BIT7 | _BIT6 | _BIT5), 0x00);

                // [7:5] SEL_DIV = 3'b000 --> 3000MHz ~ 6000MHz
                ScalerSetBit_EXINT(PB1_A3_CMU_03, ~(_BIT7 | _BIT6 | _BIT5), 0x00);
                ...
                // Analog CDR Auto FLD Counter
                ScalerSetByte_EXINT(PB1_FA_LANE0_A_CDR_04, 0xEF);
                ScalerSetByte_EXINT(PB1_FB_LANE0_A_CDR_05, 0x3B);
                ScalerSetByte_EXINT(PB1_FC_LANE0_A_CDR_06, 0xC5);
        ...
        else  // MHL 24bit Mode
        {
            ...
            ScalerSetByte_EXINT(PB1_A4_CMU_04, 0x47);

            if((GET_D2_INPUT_PIXEL_CLK() >= 700) && (GET_D2_INPUT_PIXEL_CLK() < 1125))
            {
                // [7:5] rate_sel = 3'b010 --> 750MHz ~ 1125MHz
                ScalerSetBit_EXINT(PB1_DB_ST_0, ~(_BIT7 | _BIT6 | _BIT5), _BIT6);

                // [7:5] SEL_DIV = 3'b010 --> 750MHz ~ 1125MHz
                // [4:2] CMU_PI_I_SEL = 3'b100 --> 15.625uA
                // [1:0] CMU_SELPREDIV = 2'b00 --> /1
                ScalerSetByte_EXINT(PB1_A3_CMU_03, 0x50);

                // [7:0] N_CODE = 8'b0011 1000 --> 56 + 4 = 60
                ScalerSetByte_EXINT(PB1_F2_SDM_01, 0x38);
            }
            else if((GET_D2_INPUT_PIXEL_CLK() >= 1125) && (GET_D2_INPUT_PIXEL_CLK() < 1500))
            {
                ...
                ScalerSetByte_EXINT(PB1_A3_CMU_03, 0x51);

                // [7:0] N_CODE = 8'b0111 0100 --> 116 + 4 = 120
                ScalerSetByte_EXINT(PB1_F2_SDM_01, 0x74);
            }
            else if((GET_D2_INPUT_PIXEL_CLK() >= 1500) && (GET_D2_INPUT_PIXEL_CLK() < 2000))
            {
                ...
                ScalerSetByte_EXINT(PB1_A3_CMU_03, 0x32);
            ...
            else if(GET_D2_INPUT_PIXEL_CLK() <= 3000)
            {
                ...
                // Analog CDR Auto FLD Counter
                ScalerSetByte_EXINT(PB1_FA_LANE0_A_CDR_04, 0xEF);
                ScalerSetByte_EXINT(PB1_FB_LANE0_A_CDR_05, 0x27);
                ScalerSetByte_EXINT(PB1_FC_LANE0_A_CDR_06, 0xC5);

                // [4:2] reg_sel_cdr_res = 3'b101 --> Analog CDR Rs = 6K
                ScalerSetBit_EXINT(PB1_FD_LANE0_A_CDR_07, ~(_BIT4 | _BIT3 | _BIT2), (_BIT4 | _BIT2));

                // [3:0] reg_cdr_cp_in = 4'b0101 --> Analog CDR Icp = 16.5uA
                ScalerSetBit_EXINT(PB1_FE_LANE0_A_CDR_08, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
            }
            else
            {
                ...
                // Analog CDR Auto FLD Counter
                ScalerSetByte_EXINT(PB1_FA_LANE0_A_CDR_04, 0xEF);
                ScalerSetByte_EXINT(PB1_FB_LANE0_A_CDR_05, 0x4F);
                ScalerSetByte_EXINT(PB1_FC_LANE0_A_CDR_06, 0xC5);
...
#endif
    {
        ...
        // [3:1] CMU_SEL_RI = 3'b011 --> Rs = 12KOhm
        // [0] CMU_SEL_CP = 1'b1 --> Cp = 2pF
        ScalerSetByte_EXINT(PB1_A4_CMU_04, 0xA6);

        if((GET_D2_INPUT_PIXEL_CLK() >= 187) && (GET_D2_INPUT_PIXEL_CLK() < 375))
        {
            // [7:5] rate_sel = 3'b100 --> 187.5MHz ~ 375MHz
            ScalerSetBit_EXINT(PB1_DB_ST_0, ~(_BIT7 | _BIT6 | _BIT5), _BIT7);

            // [7:5] SEL_DIV = 3'b100 --> 187.5MHz ~ 375MHz
            // [4:2] CMU_PI_I_SEL = 3'b100 --> 15.625uA
            // [1:0] CMU_SELPREDIV = 2'b00 --> /1
            ScalerSetByte_EXINT(PB1_A3_CMU_03, 0x90);

            // [7:0] N_CODE = 8'b0100 1100 --> 76 + 4 = 80
            ScalerSetByte_EXINT(PB1_F2_SDM_01, 0x4C);
        }
        else if((GET_D2_INPUT_PIXEL_CLK() >= 375) && (GET_D2_INPUT_PIXEL_CLK() < 750))
        {
            // [7:5] rate_sel = 3'b011 --> 375MHz ~ 750MHz
            ScalerSetBit_EXINT(PB1_DB_ST_0, ~(_BIT7 | _BIT6 | _BIT5), (_BIT6 | _BIT5));

            // [7:5] SEL_DIV = 3'b011 --> 375MHz ~ 750MHz
            // [4:2] CMU_PI_I_SEL = 3'b100 --> 15.625uA
            // [1:0] CMU_SELPREDIV = 2'b01 --> /2
            ScalerSetByte_EXINT(PB1_A3_CMU_03, 0x71);

            // [7:0] N_CODE = 8'b0100 1100 --> 76 + 4 = 80
            ScalerSetByte_EXINT(PB1_F2_SDM_01, 0x4C);
        }
        else if((GET_D2_INPUT_PIXEL_CLK() >= 750) && (GET_D2_INPUT_PIXEL_CLK() < 1500))
        {
            ...
            ScalerSetByte_EXINT(PB1_F2_SDM_01, 0x24);
        }
        else if((GET_D2_INPUT_PIXEL_CLK() >= 1500) && (GET_D2_INPUT_PIXEL_CLK() < 3000))
        {
        ...
        else if(GET_D2_INPUT_PIXEL_CLK() >= 3000)
        {
            ...
            ScalerSetByte_EXINT(PB1_A3_CMU_03, 0x13);

            // [4:1] CMU_PREDIVN = 4'b0110 --> /8 (N+2 Divider)
            ScalerSetBit_EXINT(PB1_A8_CMU_08, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1), (_BIT3 | _BIT2));
    ...
    ScalerSetBit_EXINT(PB1_A5_CMU_05, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT5 | _BIT3));

    // [7] BYPASS_PI = 1'b1 --> Use Integer N_CODE
    // [5] N_CODE[8] = 1'b0 --> N = N_CODE + 4
    ScalerSetBit_EXINT(PB1_F1_SDM_00, ~(_BIT7 | _BIT5), _BIT7);

    // [0] PLL_WD_EN = 1'b0 --> Disable WD
    ScalerSetBit_EXINT(PB1_F4_WD_00, ~_BIT0, 0x00);
    ...
    if((GET_D2_INPUT_PIXEL_CLK() >= 2500) && (GET_D2_INPUT_PIXEL_CLK() < 3000))
    {
        // [3:0] KD = 3'b111 --> KD = 1
        ScalerSetBit_EXINT(PB1_CC_ERROR_COUNT_0, ~(_BIT3 | _BIT2 | _BIT1), (_BIT3 | _BIT2 | _BIT1));
    }
    else
    {
        // [3:0] KD = 3'b000 --> KD = 0
        ScalerSetBit_EXINT(PB1_CC_ERROR_COUNT_0, ~(_BIT3 | _BIT2 | _BIT1), 0x00);
    }
    ...
    if(ScalerGetBit_EXINT(PB1_A0_CMU_00, _BIT6) == _BIT6) // MHL Mode
    {
        ...
        {
            // KI = 3'b011 --> KI = 1/8
            ScalerSetBit_EXINT(PB1_D4_KI_0, ~(_BIT7 | _BIT6 | _BIT5), _BIT6);

            // KP = 0x33 --> KP = 12.75
            ScalerSetByte_EXINT(PB1_D6_KP_0, 0x33);
        }
        else
        {
            // KI = 3'b000 --> KI = 0
            ScalerSetBit_EXINT(PB1_D4_KI_0, ~(_BIT7 | _BIT6 | _BIT5), 0x00);

            // KP = 0x2F --> KP = 11.75
            ScalerSetByte_EXINT(PB1_D6_KP_0, 0x2F);
        }
    }
    else   // HDMI Mode
#endif
    {
        // KI = 3'b000 --> KI = 0
        ScalerSetByte_EXINT(PB1_D4_KI_0, 0x00);
        ScalerSetByte_EXINT(PB1_D5_KI_1, 0x00);

        if(GET_D2_INPUT_PIXEL_CLK() < 2500)
        {
            // KP = 0x0F --> KP = 3.75
            ScalerSetByte_EXINT(PB1_D6_KP_0, 0x0F);
            ScalerSetByte_EXINT(PB1_D7_KP_1, 0x0F);
            ScalerSetByte_EXINT(PB1_D8_KP_2, 0x0F);
        }
        else if((GET_D2_INPUT_PIXEL_CLK() >= 2500) && (GET_D2_INPUT_PIXEL_CLK() < 3000))
        {
            // KP = 0x2D --> KP = 11.25
            ScalerSetByte_EXINT(PB1_D6_KP_0, 0x2D);
            ScalerSetByte_EXINT(PB1_D7_KP_1, 0x2D);
            ScalerSetByte_EXINT(PB1_D8_KP_2, 0x2D);
        }
        else
        {
            // KP = 0x17 --> KP = 5.75
            ScalerSetByte_EXINT(PB1_D6_KP_0, 0x17);
            ScalerSetByte_EXINT(PB1_D7_KP_1, 0x17);
            ScalerSetByte_EXINT(PB1_D8_KP_2, 0x17);
        }
    }
    ...
    ScalerSetBit_EXINT(PB1_F5_WD_01, ~_BIT4, 0x00);

    // [0] en_eqen_manual = 0 --> Disable Clkout
    ScalerSetBit_EXINT(PB1_F6_EQEN_TIMER, ~_BIT0, 0x00);

    // [0] en_data_manual = 0 --> Disable Dataout
    ScalerSetBit_EXINT(PB1_F7_DATA_TIMER, ~_BIT0, 0x00);

    // [3:0] RST_N = 4'b0000 --> Digital Circuit Reset
    ScalerSetBit_EXINT(PB1_DA_PI_0, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);

    // [3:0] RST_N = 4'b1111 --> Digital Circuit Normal
    ScalerSetBit_EXINT(PB1_DA_PI_0, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));

#if(_D2_INPUT_PORT_TYPE == _D2_MHL_PORT) // MHL 2.0 ACDR
    if((ScalerGetBit_EXINT(PB1_A0_CMU_00, _BIT6) == _BIT6) &&
       (((GET_TMDS_RX2_CLK_MODE() == _TMDS_MHL_PPMODE_PHY_SETTING)) ||
        ((GET_TMDS_RX2_CLK_MODE() == _TMDS_24BIT_PHY_SETTING) && (GET_D2_INPUT_PIXEL_CLK() >= 2000))))
    {
        // [7] Enable Lane0 ACDR
        ScalerSetBit_EXINT(PB1_B9_LANE0_A_CDR_00, ~_BIT7, _BIT7);

        // [0] Enable Lane0 ACDR_DFE
        ScalerSetBit_EXINT(PB1_FF_LANE0_A_CDR_09, ~_BIT0, _BIT0);

        // [4] reg_en_data_manual_l0 = 1'b0
        // [3] reg_bypass_data_rdy_l0 = 1'b1
        // [2] reg_en_eqen_manual_l0 = 1'b0
        // [1] reg_bypass_eqen_rdy_l0 = 1'b1
        ScalerSetBit_EXINT(PB1_FF_LANE0_A_CDR_09, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1), (_BIT3 | _BIT1));
    }
    else
#endif
    {
        // [7] Disable Lane0 ACDR
        ScalerSetBit_EXINT(PB1_B9_LANE0_A_CDR_00, ~_BIT7, 0x00);

        // [0] Disable Lane0 ACDR
        ScalerSetBit_EXINT(PB1_FF_LANE0_A_CDR_09, ~_BIT0, 0x00);
    }
    ...
    ScalerSetBit_EXINT(PB1_A8_CMU_08, ~(_BIT7 | _BIT6 | _BIT5), _BIT7);
    ...
    if(GET_D2_INPUT_PIXEL_CLK() < 2000)
    {
        ...
        // [7:5] LE_ISEL = 3'b000
        // [4:2] LE_RLSEL = 3'b011
        ScalerSetBit_EXINT(PB1_A9_CMU_09, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT3 | _BIT2));

        // [4] SEL_DFE_DELAY = 1'b1 --> Increase DFE Delay
        ScalerSetBit_EXINT(PB1_A6_CMU_06, ~_BIT4, _BIT4);
    }
    else
    {
        // LE Peaking = 1.7Gpbs
        // [7:5] LE_ISEL = 3'b010
        // [4:2] LE_RLSEL = 3'b001
        ScalerSetBit_EXINT(PB1_A9_CMU_09, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT6 | _BIT2));

        // [4] SEL_DFE_DELAY = 1'b0 --> Normal DFE Delay
        ScalerSetBit_EXINT(PB1_A6_CMU_06, ~_BIT4, 0x00);
    }
    ...
    ScalerSetBit_EXINT(PB1_AD_CDR_04, ~_BIT2, _BIT2);

    // [5] Toggle Foreground Calibration
    ScalerSetBit_EXINT(PB1_AA_CDR_01, ~_BIT5, _BIT5);
    ScalerSetBit_EXINT(PB1_AA_CDR_01, ~_BIT5, 0x00);
    ScalerSetBit_EXINT(PB1_AA_CDR_01, ~_BIT5, _BIT5);
    ...
    // Enable Tap1~2
    ScalerSetBit_EXINT(PB1_B2_EQ_00, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), (_BIT3 | _BIT2));

    // Enable Adaptation
    if(GET_D2_INPUT_PIXEL_CLK() > 3000) // 3000~3400
    {
        // Enable the Vth, Tap0 Adaptation Loop  0x041
        ScalerSetByte_EXINT(P7B_A1_L0_DFE_EN_2, 0x41);
        ScalerSetByte_EXINT(P7B_B1_L1_DFE_EN_2, 0x41);
        ScalerSetByte_EXINT(P7B_C1_L2_DFE_EN_2, 0x41);
    }
    else if(GET_D2_INPUT_PIXEL_CLK() > 375) // 375~3000
    {
        ...
        ((GET_TMDS_RX2_CLK_MODE() == _TMDS_24BIT_PHY_SETTING) && (GET_D2_INPUT_PIXEL_CLK() >= 2000))))
    {
        ...
        ScalerSetBit_EXINT(PB1_FF_LANE0_A_CDR_09, ~_BIT2, _BIT2);

        // [0] reg_rstb_fsm --> Toggle for FLD reset
        ScalerSetBit_EXINT(PB1_B9_LANE0_A_CDR_00, ~_BIT0, 0x00);
        ScalerSetBit_EXINT(PB1_B9_LANE0_A_CDR_00, ~_BIT0, _BIT0);
    ...
    {
        // Reset Digital CDR
        ScalerSetBit_EXINT(PB1_C1_TMDS_CONT_1, ~(_BIT6 | _BIT5 | _BIT4), 0x00);
        ScalerSetBit_EXINT(PB1_C1_TMDS_CONT_1, ~(_BIT6 | _BIT5 | _BIT4), (_BIT6 | _BIT5 | _BIT4));
    }

    // [7] cmu_en = 1'b1 --> Enable CMU PLL
    ScalerSetBit_EXINT(PB1_A7_CMU_07, ~_BIT7, _BIT7);
    ...
    ScalerSetBit_EXINT(PB1_F5_WD_01, ~_BIT4, _BIT4);

    // [0] en_eqen_manual = 1 --> Enable Adaptation
    ScalerSetBit_EXINT(PB1_F6_EQEN_TIMER, ~_BIT0, _BIT0);
    ...
    ScalerSetBit_EXINT(P7B_A0_L0_DFE_EN_1, ~(_BIT5 | _BIT4), _BIT5);
    ScalerSetBit_EXINT(P7B_B0_L1_DFE_EN_1, ~(_BIT5 | _BIT4), _BIT5);
    ScalerSetBit_EXINT(P7B_C0_L2_DFE_EN_1, ~(_BIT5 | _BIT4), _BIT5);
    ...
    if(GET_D2_INPUT_PIXEL_CLK() > 3000) // 3000~3400
    {
        ...
        ScalerSetBit_EXINT(P7B_A0_L0_DFE_EN_1, ~(_BIT5 | _BIT4), 0x00);
        ScalerSetBit_EXINT(P7B_B0_L1_DFE_EN_1, ~(_BIT5 | _BIT4), 0x00);
        ScalerSetBit_EXINT(P7B_C0_L2_DFE_EN_1, ~(_BIT5 | _BIT4), 0x00);

        // Enable the LE, Tap1~2 Adaptation Loop  0x06
        ScalerSetByte_EXINT(P7B_A1_L0_DFE_EN_2, 0x06);
        ScalerSetByte_EXINT(P7B_B1_L1_DFE_EN_2, 0x06);
        ScalerSetByte_EXINT(P7B_C1_L2_DFE_EN_2, 0x06);
    ...
    if(ScalerGetBit_EXINT(PB1_A0_CMU_00, _BIT6) == _BIT6) // MHL Mode
    {
        ...
        ScalerSetBit_EXINT(PB1_F9_LANE0_A_CDR_03, ~_BIT5, _BIT5);

        // [2] reg_en_eqen_manual_l0 = 1'b0
        ScalerSetBit_EXINT(PB1_FF_LANE0_A_CDR_09, ~_BIT2, 0x00);
    }
    else
#endif
    {
        ...
        ((GET_TMDS_RX2_CLK_MODE() == _TMDS_24BIT_PHY_SETTING) && (GET_D2_INPUT_PIXEL_CLK() >= 2000))))
    {
        ...
        ScalerSetBit_EXINT(PB1_FF_LANE0_A_CDR_09, ~_BIT4, _BIT4);
    }
    else
#endif
    {
        // [0] en_data_manual = 1 --> Enable Dataout
        ScalerSetBit_EXINT(PB1_F7_DATA_TIMER, ~_BIT0, _BIT0);
    }
...
void ScalerTMDSRx2IntHandler_EXINT0(void) using 1
{
    ...
    if((ScalerGetByte_EXINT(P71_E6_HDMI_FREQDET_CTRL) & 0x06) == 0x06)
    {
        ...
        {
#if(_D2_INPUT_PORT_TYPE == _D2_DUAL_DVI_PORT)
            if(ScalerTMDSRx2GetDualDVIMode_EXINT0() == _TRUE)
#endif
            {
...
#else
                ScalerSetByte_EXINT(P71_E8_HDMI_FREQDET_UPPER_M, HIBYTE(_TMDS_FREQ_NORMAL_LOW_SPEED_UPPER_BOUND));
                ScalerSetByte_EXINT(P71_E9_HDMI_FREQDET_UPPER_L, LOBYTE(_TMDS_FREQ_NORMAL_LOW_SPEED_UPPER_BOUND));
#endif
            }
...
WORD ScalerTMDSRx2MeasureClk(BYTE ucMeasureClk)
{
    ...
    if(GET_D2_TMDS_MODE() == _TMDS_MHL_MODE)
    {
        ...
        ScalerSetByte(PB1_A1_CMU_01, 0x91);
    }
    else
#endif
    {
        // Enable CMU_EN(Lane0,1,2) and Rx_EN(Lane0,1,2,3)
        ScalerSetByte(PB1_A1_CMU_01, 0xF7);
    }
...
WORD ScalerTMDSRx2MeasureClk_EXINT0(BYTE ucMeasureClk) using 1
{
    ...
    {
        // Enable CMU_EN(Lane0) and Rx_EN(Lane0,3)
        ScalerSetByte_EXINT(PB1_A1_CMU_01, 0x91);
    }
    else
#endif
    {
        // Enable CMU_EN(Lane0,1,2) and Rx_EN(Lane0,1,2,3)
        ScalerSetByte_EXINT(PB1_A1_CMU_01, 0xF7);
    }
...
bit ScalerTMDSRx2HdmiSetDeepColorPll(WORD usTMDSClkCount, BYTE ucColorDepth)
{
    ...
    ScalerSetBit(P2D_A0_MN_SCLKG_CTRL, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT7 | _BIT4));
...
#else
        ScalerSetByte(P71_E8_HDMI_FREQDET_UPPER_M, HIBYTE(_TMDS_FREQ_PS_LOW_SPEED_UPPER_BOUND));
        ScalerSetByte(P71_E9_HDMI_FREQDET_UPPER_L, LOBYTE(_TMDS_FREQ_PS_LOW_SPEED_UPPER_BOUND));
#endif
    }
...
void ScalerTMDSRx2HotPlugEvent(void)
{
    ...
    {
        // Save Z0 Status
        ucRx2Z0Status = ScalerGetBit(PB1_A2_CMU_02, (_BIT7 | _BIT6 | _BIT5 | _BIT4));
        ...
        // Restore Z0 Status
        ScalerSetBit(PB1_A2_CMU_02, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), ucRx2Z0Status);
