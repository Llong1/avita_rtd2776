...
void ScalerDpRx1Hdcp2Handler(void)
{
    ...
    if((GET_DP_RX1_HDCP2_PARING_CALCULATE() == _TRUE) && ((ScalerDpRx1GetDpcdInfo(0x06, 0x94, 0x93) & _BIT1) == 0x00))
    {
        CLR_DP_RX1_HDCP2_PARING_CALCULATE();
...
void ScalerDpRx1Hdcp2CalculateKmKh(void)
{
    ...
    SET_DP_RX1_HDCP2_PARING_CALCULATE();
    SET_DP_RX1_HDCP2_AUTHENTICATION_ACTIVE();
