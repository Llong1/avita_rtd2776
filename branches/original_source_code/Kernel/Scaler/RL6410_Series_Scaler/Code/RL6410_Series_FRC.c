...
void ScalerFRCControl(const StructSDRAMDataInfo *pstFIFOSize)
{
    ...
    if(ScalerFmtCnvFBGetStatus() == _TRUE)
    {
        ...
        // Consider Extension
        pstFIFOSize->usInputHWidth += GET_MDOMAIN_EXTENSION_LEN();
    }
#endif
    ...
    if(GET_MDOMAIN_DISPLAY_MODE() == _DISPLAY_MODE_1P)
    {
        ...
        for(ucIndex = 0; ucIndex < g_ucFRCPathCount; ucIndex ++)
        {
            ...
            ScalerSetBit(P5_44_CAP_M1_4CH_CTRL2 + usPageSelect, ~_BIT7, _BIT7);
            ScalerSetBit(P5_DD_DISP_M1_4CH_CTRL2 + usPageSelect, ~_BIT7, _BIT7);

            // Set 4 Channel Mode
            ScalerSetBit(P5_43_CAP_M1_4CH_CTRL1 + usPageSelect, ~_BIT1, _BIT1);
            ScalerSetBit(P5_DC_DISP_M1_4CH_CTRL1 + usPageSelect, ~_BIT1, _BIT1);
