...
void ScalerMHLRx4CheckWriteBurst(void);
#endif

void ScalerMHLRx4SetDevCapReg(void);
bit ScalerMHLRx4MscHandler(EnumDisplayRegion enumMappedRegion, BYTE ucModeState);
...
void ScalerMHLRx4InitialSettings(void)
{
    ...
    ScalerSetBit(P73_C2_HDCP_PCR, ~_BIT0, _BIT0);

    // Set Encryption Enable / Disable Detect Method to Enc_En First
    ScalerSetDataPortBit(P73_C3_HDCP_AP, _P73_C4_PT_C1_PORT_PAGE73_HDCP_SIR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT3);
#endif
    ScalerMHL3Rx4ECBUSInitialSetting();
#endif
}
...
void ScalerMHLRx4CBUSResetProc(void)
{
    ...
    {
        ScalerMHL3Rx4ECBUSResetProc();

        ScalerMHL3Rx4EnableECBUSMode(_DISABLE);
    }

    // Clear oCBUS -> eCBUS Statue Flags
    CLR_MHL3_RX4_SOURCE_XDEVCAP_SUPP();
    CLR_MHL3_RX4_STATUS_VERSION_3_0();
    CLR_MHL3_RX4_MSC_FEAT_REQ_UNCOMPLETE();

    SET_MHL3_RX4_ECBUS_MODE(_OFF);

    SET_MHL3_RX4_BIST_TESTING(_OFF);
    SET_MHL3_RX4_BIST_TESTING_MODE(_MHL3_ECBUS_BIST_MODE_NULL);
    SET_MHL3_RX4_BIST_ECBUS_DURATION(0x00);
    SET_MHL3_RX4_BIST_IMPEDENCE_MODE(_LOW);
...
void ScalerMHLRx4DataPortInitial(void)
{
    ...
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_80_ECBUS_SPEEDS, 0x03);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_81_TMDS_SPEEDS, 0x04);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_82_ECBUS_DEV_ROLES, 0x00);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_83_LOG_DEV_MAPX, 0x00);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_84_ACRFS_DIV_SUPPORT, 0x00);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_90_CURR_ECBUS_MODE, 0x00);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_91_AVLINK_MODE_STATUS, 0x00);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_92_AVLINK_MODE_CONTROL, 0x00);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_93_MULTI_SINK_STATUS, 0x00);
...
void ScalerMHLRx4DataPortInitial_EXINT0(void) using 1
{
    ...
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x80);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x03);

    // Reset _MSC_81_TMDS_SPEEDS
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x81);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x04);

    // Reset _MSC_82_ECBUS_DEV_ROLES
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x82);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);

    // Reset _MSC_83_LOG_DEV_MAPX
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x83);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);

    // Reset _MSC_84_ACRFS_DIV_SUPPORT
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x84);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);

    // Reset CURR_ECBUS_MODE
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x90);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);

    // Reset _MSC_91_AVLINK_MODE_STATUS
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x91);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);

    // Reset _MSC_92_AVLINK_MODE_CONTROL
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x92);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);

    // Reset _MSC_93_MULTI_SINK_STATUS
    ScalerSetByte_EXINT(P69_AC_CBUS_CTRL_0C, 0x93);
    ScalerSetByte_EXINT(P69_AD_CBUS_CTRL_0D, 0x00);
...
void ScalerMHLRx4IntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(P69_A4_CBUS_CTRL_04, (_BIT1 | _BIT0)) == (_BIT1 | _BIT0))
    {
        ...
        if((GET_MHL3_RX4_ECBUS_MODE() == _ON) || (GET_MHL3_RX4_BIST_TESTING() == _ON))
        {
            ScalerMHL3Rx4ECBUSResetProc_EXINT0();

            ScalerMHL3Rx4EnableECBUSMode_EXINT0(_DISABLE);
        }
...
bit ScalerMHLRx4MscReadDevCapabilities(EnumMHLMscOffset enumMSCOffset, BYTE *pucData, BYTE ucExtended)
{
    ...
    if(GET_MHL_RX4_READY_TO_TRANSMIT() == _TRUE)
    {
        ...
        {
            ucResultPacket = ScalerMHLRx4MscFIFOSendCommand(_MSC_READ_XDEVCAP, enumMSCOffset, _MSC_NULL_VALUE, 0, pucData);
        }
        else
#endif
        {
...
void ScalerMHLRx4MscCheckDeviceINT(void)
{
    ...
    if((bit)ScalerGetBit(P69_CE_CBUS_CTRL_2E, _BIT7) == _TRUE)
    {
...
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
        if((GET_MHL3_RX4_SOURCE_XDEVCAP_SUPP() == _TRUE) || (GET_MHL3_RX4_STATUS_VERSION_3_0() == _TRUE))
        {
            if((ScalerMHLRx4MscReadDevCapabilities(_MSC_80_ECBUS_SPEEDS, &pData[0], _MSC_READ_XDEVCAP) == _TRUE) &&
               (ScalerMHLRx4MscReadDevCapabilities(_MSC_81_TMDS_SPEEDS, &pData[1], _MSC_READ_XDEVCAP) == _TRUE) &&
               (ScalerMHLRx4MscReadDevCapabilities(_MSC_82_ECBUS_DEV_ROLES, &pData[2], _MSC_READ_XDEVCAP) == _TRUE) &&
               (ScalerMHLRx4MscReadDevCapabilities(_MSC_83_LOG_DEV_MAPX, &pData[3], _MSC_READ_XDEVCAP) == _TRUE) &&
               (ScalerMHLRx4MscReadDevCapabilities(_MSC_84_ACRFS_DIV_SUPPORT, &pData[4], _MSC_READ_XDEVCAP) == _TRUE))
            {
                if((bit)ScalerGetDataPortBit(P69_AC_CBUS_CTRL_0C, _MSC_RCHANGE_INT, _MSC_DCAP_CHG) == _TRUE)
                {
                    // Write 1 Clear DevCap_Chg Flag
        ...
        /--------------------------------------------------------------- */
        if((bit)ScalerGetDataPortBit(P69_AC_CBUS_CTRL_0C, _MSC_RCHANGE_INT, _MSC_FEAT_REQ) == _TRUE)
        {
            SET_MHL3_RX4_MSC_FEAT_REQ_UNCOMPLETE();
            ...
            if(ScalerMHLRx4MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_REQ_WRT) == _SUCCESS)
            {
                ...
                if((ScalerMHLRx4MscSendWriteBurst(0x40, ucBirstLength, &pucWriteBurstTmp[0], _MHL_WRITE_BURST_WITH_REQ) == _SUCCESS) &&
                   (ScalerMHLRx4MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_FEAT_COMPLETE) == _SUCCESS))
                {
                    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_RCHANGE_INT, _MSC_FEAT_REQ);
        ...
        //-----------------------------------------------//
        if(((bit)ScalerGetDataPortBit(P69_AC_CBUS_CTRL_0C, _MSC_CONNECTED_RDY, _MSC_XDEVCAP_SUPP) == _TRUE) && (GET_MHL3_RX4_SOURCE_XDEVCAP_SUPP() == _FALSE))
        {
            SET_MHL3_RX4_SOURCE_XDEVCAP_SUPP();
...
#endif
            if((GET_MHL_RX4_MHL_VERSION() >= _MHL_VERSION_3_0) && (ScalerGetBit(P69_00_OCBUS_CTRL_00, _BIT7) == 0x00))
            {
                // Enable MHL 3.0 CBUS Extended MSC Function
                ScalerSetBit(P69_00_OCBUS_CTRL_00, ~_BIT7, _BIT7);

                // Read XDEVCAP Reg. When Receive XDEVCAP_SUPP, For 3.0 CTS
                if(ScalerMHLRx4MscReadDevCapabilities(_MSC_80_ECBUS_SPEEDS, pData, _MSC_READ_XDEVCAP) == _SUCCESS)
                {
                    // Clear Flag
                    ScalerSetBit(P69_CE_CBUS_CTRL_2E, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT7);
                }
        ...
        //--------------------------------------------------//
        ScalerGetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_MHL_VERSION_STAT, 1, &pData[0], _AUTOINC);

        if((pData[0] >= 0x30) && (GET_MHL3_RX4_STATUS_VERSION_3_0() == _FALSE) && (ScalerGetBit(P69_00_OCBUS_CTRL_00, _BIT7) == _BIT7))
        {
            SET_MHL3_RX4_STATUS_VERSION_3_0();
            ...
            if(ScalerMHLRx4MscSendCommand(_MSC_WRITE_XSTAT, _MSC_90_CURR_ECBUS_MODE, _MSC_ECBUS_S_MODE) == _SUCCESS)
            {
                // Clear Flag
                ScalerSetBit(P69_CE_CBUS_CTRL_2E, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT7);
            }
    ...
    if(((bit)ScalerGetBit(P69_10_OCBUS_CTRL_10, _BIT1) == _TRUE) && (ScalerGetBit(P69_00_OCBUS_CTRL_00, _BIT7) == _BIT7))
    {
        //--------------------------------------//
        //---- Get Source MHL AV Link Rate -----//
        //--------------------------------------//
        ScalerGetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_92_AVLINK_MODE_CONTROL, 1, &ucAVLinkNCode, _AUTOINC);

        if(ucAVLinkNCode != GET_MHL3_RX4_AV_LINK_RATE())
        {
            switch(ucAVLinkNCode & (_BIT2 | _BIT1 | _BIT0))
            {
                case _ECBUS_LINK_RATE_1_5:

                    SET_MHL3_RX4_AV_LINK_RATE(_ECBUS_LINK_RATE_1_5);
                    SET_MHL3_RX4_AV_LINK_N_CODE(_ECBUS_N_CODE_1_5);

                    ScalerMHLRx4MscSendCommand(_MSC_WRITE_XSTAT, _MSC_91_AVLINK_MODE_STATUS, _MSC_CRU_LOCKED);

                    break;

                case _ECBUS_LINK_RATE_3_0:

                    SET_MHL3_RX4_AV_LINK_RATE(_ECBUS_LINK_RATE_3_0);
                    SET_MHL3_RX4_AV_LINK_N_CODE(_ECBUS_N_CODE_3_0);
                ...
                case _ECBUS_LINK_RATE_6_0:
                    ...
                    SET_MHL3_RX4_AV_LINK_RATE(_ECBUS_LINK_RATE_6_0);
                    SET_MHL3_RX4_AV_LINK_N_CODE(_ECBUS_N_CODE_6_0);
            ...
            while((usTmp < 10) && (ScalerMHL3Rx4DataSignalDetect() == _FALSE))
            {
            ...
            if((GET_MHL3_RX4_ECBUS_MODE() == _ON) &&
               (GET_MHL3_RX4_AV_LINK_RATE() != _ECBUS_LINK_RATE_NULL) &&
               (GET_MHL3_RX4_AV_LINK_N_CODE() != _ECBUS_N_CODE_NULL))
            {
#if(_MHL3_ECBUS_AVLINK_DEBUG_MESSAGE == _ON)
                DebugMessageMHL("4-- Rx4 Xstat Written AV Link Rate = ", ucAVLinkNCode);
#endif

#if(_MHL3_ECBUS_AVLINK_CDR_MODE == _DCDR_MODE)
                // ECBUS Data Link Set PHY
                ScalerTMDSRx4MHL3DcdrSetPhy();
                ...
                // Clear Flag
                ScalerSetBit(P69_10_OCBUS_CTRL_10, ~(_BIT1 | _BIT0), _BIT1);
            }
        }
    }
...
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
//--------------------------------------------------
// Description  : Check Write Burst for D4 Port
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerMHLRx4CheckWriteBurst(void)
{
    // Receive Write_Burst
    if(((bit)ScalerGetBit(P69_CF_CBUS_CTRL_2F, _BIT7) == _TRUE) && (GET_MHL_RX4_WRITE_BURST_PROCESS_DONE() == _FALSE))
    {
        BYTE ucTmp = 0;
        BYTE ucTmp2 = 0;
        ...
        ScalerGetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_40_SCRATCHPAD_OFFSET, ucFifoLength, pucFifoRxArray, _AUTOINC);

#if(_MHL3_ECBUS_WRITEBURST_DEBUG_MESSAGE == _ON)

        DebugMessageMHL("WB Rx4 Seq", pucFifoRxArray[4]);
        DebugMessageMHL("WB Rx4 Tot_Seq", pucFifoRxArray[3]);

        for(ucTmp2 = 0; ucTmp2 < ucFifoLength; ucTmp2++)
        {
            DebugMessageMHL("WB Rx4", pucFifoRxArray[ucTmp2]);
        }
#endif
        ...
        if((((WORD)pucFifoRxArray[0] << 8) | ((WORD)pucFifoRxArray[1] << 0)) == (((WORD)_MHL_WRITE_BURST_ECBUS_VC_ASSIGN_HBYTE << 8) | ((WORD)_MHL_WRITE_BURST_ECBUS_VC_ASSIGN_LBYTE << 0)))
        {
            ...
            SET_MHL3_RX4_ECBUS_VC_ASSIGN_NUM_ENT(ucSeq, pucFifoRxArray[5]);
            SET_MHL3_RX4_ECBUS_VC_ASSIGN_WB_LENGTH(ucSeq, ucFifoLength);

            // CBUS1 Size = 1
            SET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_SIZE(_ECBUS_CBUS1_VC_NUM, _ECBUS_CBUS1_VC_SIZE);

            // Scan Assigened VC Size
            for(ucTmp = 0; ucTmp < GET_MHL3_RX4_ECBUS_VC_ASSIGN_NUM_ENT(ucSeq); ucTmp++)
            {
                SET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_NUM((ucTmp + 1), pucFifoRxArray[(3 * ucTmp) + 6]);
                SET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_ID((ucTmp + 1), pucFifoRxArray[(3 * ucTmp) + 6 + 1]);
                SET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_SIZE((ucTmp + 1), pucFifoRxArray[(3 * ucTmp) + 6 + 2]);
                SET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_COUNT(GET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_COUNT() + 1);
            }

            // Check Entry Count of Received VC Assign
            for(ucTmp = 1; ucTmp <= ucSeq; ucTmp++)
            {
                ucNumEnt = ucNumEnt + GET_MHL3_RX4_ECBUS_VC_ASSIGN_NUM_ENT(ucTmp);
            }
            ...
            if(ucNumEnt == ucTotEnt)
            {
                ...
                if(GET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_SIZE(_ECBUS_EMSC_VC_NUM) != 0x00)
                {
                    // Reallocate eMSC Virtual Channel with Assigened eMSC VC Size
                    if(ScalerMHL3Rx4ECBUSTdmReallocation() == _SUCCESS)
                    {
                        ...
                        for(ucTmp = 1; ucTmp <= ucSeq; ucTmp++)
                        {
                            ...
                            pucFifoTxArray[5] = GET_MHL3_RX4_ECBUS_VC_ASSIGN_NUM_ENT(ucTmp);

                            for(ucTmp2 = 0; ucTmp2 < GET_MHL3_RX4_ECBUS_VC_ASSIGN_NUM_ENT(ucTmp); ucTmp2++)
                            {
                                pucFifoTxArray[(3 * ucTmp2) + 6] = GET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_NUM(ucTmp2 + 1);
                                pucFifoTxArray[(3 * ucTmp2) + 6 + 1] = GET_MHL3_RX4_ECBUS_VC_ASSIGN_VC_ID(ucTmp2 + 1);
                            ...
                            // Compute Check Sum of Write_Burst
                            for(ucTmp2 = 0; ucTmp2 < GET_MHL3_RX4_ECBUS_VC_ASSIGN_WB_LENGTH(ucTmp); ucTmp2++)
                            {
                                if(ucTmp2 != 0x02)
                                {
                            ...
                            if(ScalerMHLRx4MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_REQ_WRT) == _SUCCESS)
                            {
                                ...
                                while((ucTmp2-- > 0) && ((bit)ScalerGetDataPortBit(P69_AC_CBUS_CTRL_0C, _MSC_RCHANGE_INT, _MSC_GRT_WRT) != _TRUE))
                                {
                                    ScalerTimerDelayXms(5);
                                }

                                if(ScalerMHLRx4MscSendWriteBurst(0x40, GET_MHL3_RX4_ECBUS_VC_ASSIGN_WB_LENGTH(ucTmp), &pucFifoTxArray, _MHL_WRITE_BURST_WITH_REQ) == _SUCCESS)
                                {
                                    // Clear Flag
                                    ScalerSetBit(P69_CF_CBUS_CTRL_2F, ~_BIT7, _BIT7);
...
#if(_MHL3_ECBUS_WRITEBURST_DEBUG_MESSAGE == _ON)
                        if(GET_MHL3_RX4_ECBUS_VC_ASSIGN_WB_LENGTH(ucTmp) > 0x00)
                        {
                            DebugMessageMHL("WB Tx Seq", ucTmp);
                            DebugMessageMHL("WB Tx Length", GET_MHL3_RX4_ECBUS_VC_ASSIGN_WB_LENGTH(ucTmp));
        ...
        else if((((WORD)pucFifoRxArray[0] << 8) | ((WORD)pucFifoRxArray[1] << 0)) == ((((WORD)_MHL_WRITE_BURST_ECBUS_BIST_SETUP_HBYTE << 8)) | ((WORD)_MHL_WRITE_BURST_ECBUS_BIST_SETUP_LBYTE << 0)))
        {
            ...
            SET_MHL3_RX4_BIST_ECBUS_DURATION(pucFifoRxArray[3]);

            if(pucFifoRxArray[3] != 0x00)
            {
                if(pucFifoRxArray[4] == 0x01) // ECBUS PRBS
                {
                    ScalerSetBit(P6B_35_ECBUS_BIST_CONFIG, ~_BIT3, 0x00);
                    ucECBUSBISTReady = ucECBUSBISTReady | _BIT0;
                }
                else if(pucFifoRxArray[4] == 0x02) // ECBUS Fixed 8
                {
                    ScalerSetBit(P6B_35_ECBUS_BIST_CONFIG, ~_BIT3, _BIT3);
                    ScalerSetByte(P6B_36_ECBUS_BIST_FIXED8, pucFifoRxArray[6]);
                    ucECBUSBISTReady = ucECBUSBISTReady | _BIT0;
                }
                else
                {
            ...
            if(pucFifoRxArray[11] != 0x00)
            {
                ...
                ScalerSetBit(P78_02_MHL_BIST_CTRL, ~_BIT4, _BIT4);

                // Set AV Link Duration = ucFifoRxArray[11] x 32 Frames
                ScalerSetByte(P78_0D_MHL_BIST_DURATION, pucFifoRxArray[11]);
            }
            else
            {
                // Set AV Link Duration to Continuous Mode
                ScalerSetBit(P78_02_MHL_BIST_CTRL, ~_BIT4, 0x00);
            }
            ...
            {
                ScalerSetBit(P78_02_MHL_BIST_CTRL, ~(_BIT6 | _BIT5), _BIT5);

                // Switch Align Mode for Fixed 8/ PRBS
                ScalerSetBit(P78_03_MHL_BIST_CONFIG_1, ~_BIT4, 0X00);

                ucECBUSBISTReady = ucECBUSBISTReady | _BIT1;
            }
            else if(pucFifoRxArray[9] == 0x02) // AV Fixed 8
            {
                ScalerSetBit(P78_02_MHL_BIST_CTRL, ~(_BIT6 | _BIT5), _BIT6);

                // Switch Align Mode for Fixed 8/ PRBS
                ScalerSetBit(P78_03_MHL_BIST_CONFIG_1, ~_BIT4, 0X00);

                // Set Fixed 8 Patten
                ScalerSetByte(P78_04_MHL_BIST_CONFIG_2, pucFifoRxArray[13]);

                ucECBUSBISTReady = ucECBUSBISTReady | _BIT1;
            }
            else if(pucFifoRxArray[9] == 0x03) // AV Fixed 10
            {
                ScalerSetBit(P78_02_MHL_BIST_CTRL, ~(_BIT6 | _BIT5), (_BIT6 | _BIT5));

                // Set Fixed 10 Patten Inversion
                // Switch Align Mode for Fixed 10
                ScalerSetBit(P78_03_MHL_BIST_CONFIG_1, ~(_BIT5 | _BIT4), (((pucFifoRxArray[12] & _BIT7) >> 2) | _BIT4));

                // Set Fixed 10 Patten
                ScalerSetBit(P78_03_MHL_BIST_CONFIG_1, ~(_BIT1 | _BIT0), (pucFifoRxArray[12] & 0x11));
                ScalerSetByte(P78_04_MHL_BIST_CONFIG_2, pucFifoRxArray[13]);
            ...
            ScalerSetBit(P78_02_MHL_BIST_CTRL, ~_BIT2, (((~pucFifoRxArray[14]) & _BIT0) << 2));
            ...
            switch(pucFifoRxArray[15])
            {
                case _AV_LINK_RX:
                    ...
                    ScalerSetBit(P7D_18_IMPEDANCE_00, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                    ScalerSetBit(P7D_18_IMPEDANCE_00, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));

                    SET_MHL3_RX4_BIST_IMPEDENCE_MODE(_AV_LINK_RX);
                ...
                case _ECBUS_S_TX_LOW:
                    ...
                    ScalerSetBit(P1E_06_ECBUS_Z0_CTRL_0, ~_BIT2, 0x00);
                    ScalerSetBit(P1E_06_ECBUS_Z0_CTRL_0, ~_BIT2, _BIT2);

                    SET_MHL3_RX4_BIST_IMPEDENCE_MODE(_ECBUS_S_TX_LOW);
                ...
                case _ECBUS_S_TX_HIGH:
                    ...
                    SET_MHL3_RX4_BIST_IMPEDENCE_MODE(_ECBUS_S_TX_HIGH);
                ...
                case _ECBUS_S_RX:
                    ...
                    SET_MHL3_RX4_BIST_IMPEDENCE_MODE(_ECBUS_S_RX);
            ...
            if(ScalerMHLRx4MscSendCommand(_MSC_MSG, _MSC_BIST_READY, ucECBUSBISTReady) == _SUCCESS)
            {
#if(_MHL3_BIST_FUNCTION_DEBUG_MESSAGE == _ON)
...
void ScalerMHLRx4SetDevCapReg(void)
{
    ...
    // Adopter ID
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_ADOPTER_ID_H_03, (BYTE)(((WORD)_MHL3_ADOPTER_ID >> 8) & 0x00FF));
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_ADOPTER_ID_L_04, (BYTE)(_MHL3_ADOPTER_ID & 0x00FF));
#else
...
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
    ScalerGetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_VID_LINK_MODE_05, 1, pData, _AUTOINC);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_VID_LINK_MODE_05, (pData[0] | ((BYTE)_MHL2_PP_MODE_SUPPORT << 3) | ((BYTE)_MHL3_16_BIT_MODE_SUPPORT << 6)));
#else
...
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
    ScalerSetDataPortBit(P69_AC_CBUS_CTRL_0C, _MSC_AUD_LINK_MODE_06, ~(_BIT2 | _BIT1 | _BIT0), (_MHL3_AUD_HBR | _MHL3_AUD_CHANNEL));
#else
...
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
    ScalerSetDataPortBit(P69_AC_CBUS_CTRL_0C, _MSC_FEATURE_FLAG_0A, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (((BYTE)_MHL3_RBP_SUPPORT << 6) | ((BYTE)_MHL3_XVYCC_SUPPORT << 5) | ((BYTE)_MHL3_UCP_SUPPORT << 4) | (_MHL3_UCP_SUPPORT << 3) | (_BIT2 | _BIT1 | _BIT0)));
#else
    ...
    // Device ID
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_DEVICE_ID_H_0B, (BYTE)(((WORD)_MHL3_DEVICE_ID >> 8) & 0x00FF));
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_DEVICE_ID_L_0C, (BYTE)(_MHL3_DEVICE_ID & 0x00FF));
#else
    ...
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_81_TMDS_SPEEDS, 0x07);

    // HID Support
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_82_ECBUS_DEV_ROLES, (BYTE)((_MHL3_ECBUS_HID_SUPPORT << 4) & _BIT4));
    ...
    ScalerSetBit(P69_C8_CBUS_CTRL_28, ~_BIT7, _BIT7);
    ScalerSetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_92_AVLINK_MODE_CONTROL, _ECBUS_LINK_RATE_NULL);
    ScalerSetBit(P69_C8_CBUS_CTRL_28, ~_BIT7, 0x00);
...
bit ScalerMHLRx4MscHandler(EnumDisplayRegion enumMappedRegion, BYTE ucModeState)
{
    ...
    ScalerMHL3Rx4ECBUSTxTestSettingFunction();
#endif
#if(_ECBUS_RX_TEST_FUNCTION == _ON)
    ScalerMHL3Rx4ECBUSRxTestSettingFunction();
#endif
    ...
    switch(GET_MHL_RX4_PROCESS_STATE())
    {
        ...
        case _MHL_STATE_DISCOVERY_DONE:
            ...
            if((GET_MHL3_RX4_SOURCE_XDEVCAP_SUPP() == _FALSE) && (GET_MHL3_RX4_STATUS_VERSION_3_0() == _FALSE))
            {
                ...
                ScalerTimerActiveTimerEvent(SEC(0.5), _SCALER_TIMER_EVENT_MHL3_RX4_WAIT_SRC_MHL_VERSION);
            }
#endif
    ...
    if((enumMappedRegion != _DISPLAY_RGN_NONE) && (ucModeState != _MODE_STATUS_INITIAL) && (ucModeState != _MODE_STATUS_POWER_OFF))
    {
        switch(GET_MHL_RX4_PROCESS_STATE())
        {
            case _MHL_STATE_SET_DEV_CAP_DONE:
                ...
                if((_D4_MHL_VERSION >= _MHL_VERSION_3_0) &&
                   (GET_MHL3_RX4_WAIT_SRC_MHL_VERSION_TMOUT() == _FALSE) &&
                   (GET_MHL3_RX4_ECBUS_START_UP_TMOUT() == _FALSE))
                {
                    /* ----------------------------------------------------------------------------------------------
                    ...
                    ScalerGetDataPortByte(P69_AC_CBUS_CTRL_0C, _MSC_DEV_CAT_02, 1, &ucMSCDcapRdy, _AUTOINC);

                    // Ecode CONNECTED_RDY State Reg.
                    ucMSCDcapRdy = ((ucMSCDcapRdy >> 2) & (_MSC_PLIM_STAT | _MSC_POW_STAT)) | _MSC_XDEVCAP_SUPP | _MSC_DCAP_RDY;

                    if((ScalerMHLRx4MscSendCommand(_MSC_WRITE_STAT, _MSC_MHL_VERSION_STAT, _MSC_MHL_VERSION_3_0) == _SUCCESS) &&
                       (ScalerMHLRx4MscSendCommand(_MSC_WRITE_STAT, _MSC_CONNECTED_RDY, ucMSCDcapRdy) == _SUCCESS) &&
                       (ScalerMHLRx4MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_DCAP_CHG) == _SUCCESS))
                    {
                        ...
                        if((GET_MHL3_RX4_ECBUS_MODE() == _OFF) && (GET_MHL3_RX4_BIST_TESTING() == _OFF))
                        {
                            ...
                            ScalerTimerActiveTimerEvent(SEC(1.5), _SCALER_TIMER_EVENT_MHL3_RX4_WAIT_SRC_RAP_CBUS_UP);
                        }

                        DebugMessageMHL("D4 MHL Dev Cap RDY", (0x10 | (GET_MHL3_RX4_ECBUS_MODE() << 1) | (GET_MHL3_RX4_BIST_TESTING())));
...
#endif // End of #if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
                {
                    ...
                    {
#if(_D4_MHL_VERSION >= _MHL_VERSION_3_0)
                        DebugMessageMHL("D4 MHL Dev Cap RDY", (0x20 | (GET_MHL3_RX4_WAIT_SRC_MHL_VERSION_TMOUT() << 1) | (GET_MHL3_RX4_ECBUS_START_UP_TMOUT())));
#else
            ...
            case _MHL_STATE_DEV_CAP_RDY:
                ...
                {
                    if(((GET_MHL3_RX4_SOURCE_XDEVCAP_SUPP() == _TRUE) || (GET_MHL3_RX4_STATUS_VERSION_3_0() == _TRUE)) &&
                       (GET_MHL3_RX4_ECBUS_MODE() == _ON) && (GET_MHL3_RX4_ECBUS_START_UP_TMOUT() == _FALSE))
                    {
                        if((GET_MHL3_RX4_ECBUS_PROCESS_STATE() > _MHL3_ECBUS_STATE_TDM_SYNC_DONE) && (ScalerGetBit(P69_00_OCBUS_CTRL_00, _BIT6) == _BIT6))
                        {
                            ...
                            if(ScalerMHLRx4MscSendCommand(_MSC_SET_HPD, _MSC_NULL_ADDRESS, _MSC_NULL_VALUE) == _SUCCESS)
                            {
                                ...
                                ScalerMHLRx4MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_FEAT_REQ);

                                DebugMessageMHL("D4 MHL HPD Done", (0x10 | (GET_MHL3_RX4_ECBUS_START_UP_TMOUT())));
                    ...
                    {
                        if((GET_MHL3_RX4_WAIT_SRC_RAP_CBUS_UP_TMOUT() == _TRUE) || (GET_MHL3_RX4_WAIT_SRC_MHL_VERSION_TMOUT() == _TRUE))
                        {
#if(_MHL3_ECBUS_STARTUP_DEBUG_MESSAGE == _ON)
                            DebugMessageMHL("-- 3-2 -- Wait Source Rap Mpde Up TMOUT", ((GET_MHL3_RX4_WAIT_SRC_RAP_CBUS_UP_TMOUT() << 1) | (GET_MHL3_RX4_WAIT_SRC_MHL_VERSION_TMOUT())));
#endif
                            // MHL3 Wait RAP_CBUS_UP TMOUT -> Back to MHL2 //
                            // Enable Stuck Low IRQ and Clear Stuck Low Flags //
                            ScalerSetBit(P69_A4_CBUS_CTRL_04, ~(_BIT1 | _BIT0), _BIT0);

                            ScalerTimerDelayXms(80);

                            if(ScalerMHLRx4MscSendCommand(_MSC_SET_HPD, _MSC_NULL_ADDRESS, _MSC_NULL_VALUE) == _SUCCESS)
                            {
                                DebugMessageMHL("D4 MHL HPD Done", (0x20 | (GET_MHL3_RX4_ECBUS_START_UP_TMOUT())));

                                SET_MHL_RX4_PROCESS_STATE(_MHL_STATE_HPD_DONE);
                            }
                        }
                        else if((GET_MHL3_RX4_ECBUS_START_UP_TMOUT() == _TRUE) && (GET_MHL3_RX4_ECBUS_MODE() == _ON))
                        {
#if(_MHL3_ECBUS_STARTUP_DEBUG_MESSAGE == _ON)
                            DebugMessageMHL("-- 3-3 -- GET_MHL3_ECBUS_START_UP_TMOUT", GET_MHL3_RX4_ECBUS_START_UP_TMOUT());
#endif
            ...
            case _MHL_STATE_HPD_DONE:
                ...
                if(GET_MHL3_RX4_ECBUS_MODE() == _ON)
                {
                    ...
                    if(GET_MHL3_RX4_MSC_FEAT_REQ_UNCOMPLETE() == _FALSE)
                    {
                        if(ScalerMHLRx4MscSendCommand(_MSC_WRITE_STAT, _MSC_LINK_MODE, _MSC_PATH_EN) == _SUCCESS)
                        {
                            DebugMessageMHL("D4 MHL Path Enabled", 0x10);
            ...
            case _MHL_STATE_PATH_EN_DONE:
                ...
                if(GET_TMDS_RX4_PHY_SET() == _TRUE)
                {
                    ...
                    if(GET_MHL3_RX4_ECBUS_MODE() == _ON)
                    {
                        ScalerMHLRx4MscSendCommand(_MSC_WRITE_XSTAT, _MSC_91_AVLINK_MODE_STATUS, _MSC_TMDS_NORMAL);
                    }
                ...
                {
                    if((GET_MHL3_RX4_ECBUS_MODE() == _ON) && (ScalerMHL3Rx4DataSignalDetect() == _TRUE))
                    {
                        if((GET_MHL3_RX4_AV_LINK_RATE() == _ECBUS_LINK_RATE_NULL) &&
                           (GET_MHL3_RX4_AV_LINK_N_CODE() == _ECBUS_N_CODE_NULL) &&
                           (ScalerGetByte(P6D_2C_HDCP_I2C_CTRL_6) == 0x10))
                        {
                            SET_MHL3_RX4_AV_LINK_RATE(_ECBUS_LINK_RATE_1_5);
                            SET_MHL3_RX4_AV_LINK_N_CODE(_ECBUS_N_CODE_1_5);
                            ...
                            DebugMessageMHL("D4 HDCP2.2 Auth Done", 0x00);
                        }
            ...
            case _MHL_STATE_BIST_TESTING:
                ...
                if((GET_MHL3_RX4_ECBUS_START_UP_TMOUT() == _TRUE) && (GET_MHL3_RX4_BIST_TESTING() == _ON))
                {
#if(_MHL3_BIST_FUNCTION_DEBUG_MESSAGE == _ON)
                    DebugMessageMHL("D4 BIST eCBUS Start Up Fail", 0x00);
#endif
                    ScalerMHLRx4CBUSResetProc();
                }

                if((GET_MHL3_RX4_ECBUS_PROCESS_STATE() == _MHL3_ECBUS_STATE_ECBUS_DONE) && (GET_MHL3_RX4_BIST_TESTING() == _ON))
                {
#if(_MHL3_BIST_FUNCTION_DEBUG_MESSAGE == _ON)
                    DebugMessageMHL("5 BIST Done", ScalerGetBit(P78_01_MHL_FIFO_CTRL, _BIT0));
#endif
                    ScalerMHLRx4CBUSResetProc();
                }
...
bit ScalerMHLRx4MscRAPHandler(void)
{
    ...
    if((bit)ScalerGetBit(P69_D4_CBUS_CTRL_34, _BIT3) == _TRUE)
    {
        ...
        if((ScalerGetByte(P69_D2_CBUS_CTRL_32) != 0x00) &&
           ((GET_MHL_RX4_ADOPTER_ID_HBYTE() == _UTS800_SL863_ADOPTER_ID_HBYTE) &&
            (GET_MHL_RX4_ADOPTER_ID_LBYTE() == _UTS800_SL863_ADOPTER_ID_LBYTE)))
        {
            // Clear Flag
        ...
        switch(ScalerGetByte(P69_DC_CBUS_CTRL_3C))
        {
            ...
            case _MSC_RAP_CBUS_MODE_DOWN:
                ...
                if(ScalerMHLRx4MscSendCommand(_MSC_MSG, _MSC_RAPK, _MSC_RAPK_NO_ERROR) == _TRUE)
                {
                    ScalerMHLRx4CBUSResetProc();
            ...
            case _MSC_RAP_CBUS_MODE_UP:
                ...
                if(ScalerMHLRx4MscSendCommand(_MSC_MSG, _MSC_RAPK, _MSC_RAPK_NO_ERROR) == _TRUE)
                {
                    if(GET_MHL3_RX4_ECBUS_MODE() == _OFF)
                    {
                        //-------- Disable Stuck Low IRQ and Clear Stuck Low Flags --------//
                        ...
                        ScalerSetBit(P6B_3C_ECBUS_SRAM_BIST, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
                        ScalerSetByte(P6B_4B_ECBUS_TIMEOUT_RESERVE, 0x00);
                        ...
                        ScalerSetByte(P6B_33_ECBUS_EMSC_CRC_RESERVE, 0x00);

                        // Reset Recorded "_WAIT_ACTIVE_END_TIME"
                        ScalerSetByte(P6B_3B_ECBUS_BIST_RESERVE, 0x00);

                        // Enable eCBUS Mode
                        SET_MHL3_RX4_ECBUS_MODE(_ON);
