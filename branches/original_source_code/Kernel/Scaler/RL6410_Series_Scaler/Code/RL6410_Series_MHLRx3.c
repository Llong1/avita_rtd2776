...
void ScalerMHLRx3InitialSettings(void)
{
    ...
    ScalerSetBit(P72_C2_HDCP_PCR, ~_BIT0, _BIT0);

    // Set Encryption Enable / Disable Detect Method to Enc_En First
    ScalerSetDataPortBit(P72_C3_HDCP_AP, _P72_C4_PT_C1_PORT_PAGE72_HDCP_SIR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT3);
#endif
    ScalerMHL3Rx3ECBUSInitialSetting();
#endif
}
...
void ScalerMHLRx3CBUSResetProc(void)
{
    ...
    {
        ScalerMHL3Rx3ECBUSResetProc();

        ScalerMHL3Rx3EnableECBUSMode(_DISABLE);
    }

    // Clear oCBUS -> eCBUS Statue Flags
    CLR_MHL3_RX3_SOURCE_XDEVCAP_SUPP();
    CLR_MHL3_RX3_STATUS_VERSION_3_0();
    CLR_MHL3_RX3_MSC_FEAT_REQ_UNCOMPLETE();

    SET_MHL3_RX3_ECBUS_MODE(_OFF);

    SET_MHL3_RX3_BIST_TESTING(_OFF);
    SET_MHL3_RX3_BIST_TESTING_MODE(_MHL3_ECBUS_BIST_MODE_NULL);
    SET_MHL3_RX3_BIST_ECBUS_DURATION(0x00);
    SET_MHL3_RX3_BIST_IMPEDENCE_MODE(_LOW);
...
void ScalerMHLRx3IntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(P68_A4_CBUS_CTRL_04, (_BIT1 | _BIT0)) == (_BIT1 | _BIT0))
    {
        ...
        if((GET_MHL3_RX3_ECBUS_MODE() == _ON) || (GET_MHL3_RX3_BIST_TESTING() == _ON))
        {
            ScalerMHL3Rx3ECBUSResetProc_EXINT0();

            ScalerMHL3Rx3EnableECBUSMode_EXINT0(_DISABLE);
        }
...
bit ScalerMHLRx3MscHandler(EnumDisplayRegion enumMappedRegion, BYTE ucModeState)
{
    ...
    ScalerMHL3Rx3ECBUSTxTestSettingFunction();
#endif
#if(_ECBUS_RX_TEST_FUNCTION == _ON)
    ScalerMHL3Rx3ECBUSRxTestSettingFunction();
#endif
    ...
    switch(GET_MHL_RX3_PROCESS_STATE())
    {
        ...
        case _MHL_STATE_DISCOVERY_DONE:
            ...
            if((GET_MHL3_RX3_SOURCE_XDEVCAP_SUPP() == _FALSE) && (GET_MHL3_RX3_STATUS_VERSION_3_0() == _FALSE))
            {
                ...
                ScalerTimerActiveTimerEvent(SEC(0.5), _SCALER_TIMER_EVENT_MHL3_RX3_WAIT_SRC_MHL_VERSION);
            }
#endif
    ...
    if((enumMappedRegion != _DISPLAY_RGN_NONE) && (ucModeState != _MODE_STATUS_INITIAL) && (ucModeState != _MODE_STATUS_POWER_OFF))
    {
        switch(GET_MHL_RX3_PROCESS_STATE())
        {
            case _MHL_STATE_SET_DEV_CAP_DONE:
                ...
                if((_D3_MHL_VERSION >= _MHL_VERSION_3_0) &&
                   (GET_MHL3_RX3_WAIT_SRC_MHL_VERSION_TMOUT() == _FALSE) &&
                   (GET_MHL3_RX3_ECBUS_START_UP_TMOUT() == _FALSE))
                {
                    /* ----------------------------------------------------------------------------------------------
                    ...
                    ScalerGetDataPortByte(P68_AC_CBUS_CTRL_0C, _MSC_DEV_CAT_02, 1, &ucMSCDcapRdy, _AUTOINC);

                    // Ecode CONNECTED_RDY State Reg.
                    ucMSCDcapRdy = ((ucMSCDcapRdy >> 2) & (_MSC_PLIM_STAT | _MSC_POW_STAT)) | _MSC_XDEVCAP_SUPP | _MSC_DCAP_RDY;

                    if((ScalerMHLRx3MscSendCommand(_MSC_WRITE_STAT, _MSC_MHL_VERSION_STAT, _MSC_MHL_VERSION_3_0) == _SUCCESS) &&
                       (ScalerMHLRx3MscSendCommand(_MSC_WRITE_STAT, _MSC_CONNECTED_RDY, ucMSCDcapRdy) == _SUCCESS) &&
                       (ScalerMHLRx3MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_DCAP_CHG) == _SUCCESS))
                    {
                        ...
                        if((GET_MHL3_RX3_ECBUS_MODE() == _OFF) && (GET_MHL3_RX3_BIST_TESTING() == _OFF))
                        {
                            ...
                            ScalerTimerActiveTimerEvent(SEC(1.5), _SCALER_TIMER_EVENT_MHL3_RX3_WAIT_SRC_RAP_CBUS_UP);
                        }

                        DebugMessageMHL("D3 MHL Dev Cap RDY", (0x10 | (GET_MHL3_RX3_ECBUS_MODE() << 1) | (GET_MHL3_RX3_BIST_TESTING())));
...
#endif // End of #if(_D3_MHL_VERSION >= _MHL_VERSION_3_0)
                {
                    ...
                    {
#if(_D3_MHL_VERSION >= _MHL_VERSION_3_0)
                        DebugMessageMHL("D3 MHL Dev Cap RDY", (0x20 | (GET_MHL3_RX3_WAIT_SRC_MHL_VERSION_TMOUT() << 1) | (GET_MHL3_RX3_ECBUS_START_UP_TMOUT())));
#else
            ...
            case _MHL_STATE_DEV_CAP_RDY:
                ...
                {
                    if(((GET_MHL3_RX3_SOURCE_XDEVCAP_SUPP() == _TRUE) || (GET_MHL3_RX3_STATUS_VERSION_3_0() == _TRUE)) &&
                       (GET_MHL3_RX3_ECBUS_MODE() == _ON) && (GET_MHL3_RX3_ECBUS_START_UP_TMOUT() == _FALSE))
                    {
                        if((GET_MHL3_RX3_ECBUS_PROCESS_STATE() > _MHL3_ECBUS_STATE_TDM_SYNC_DONE) && (ScalerGetBit(P68_00_OCBUS_CTRL_00, _BIT6) == _BIT6))
                        {
                            ...
                            if(ScalerMHLRx3MscSendCommand(_MSC_SET_HPD, _MSC_NULL_ADDRESS, _MSC_NULL_VALUE) == _SUCCESS)
                            {
                                ...
                                ScalerMHLRx3MscSendCommand(_MSC_SET_INT, _MSC_RCHANGE_INT, _MSC_FEAT_REQ);

                                DebugMessageMHL("D3 MHL HPD Done", (0x10 | (GET_MHL3_RX3_ECBUS_START_UP_TMOUT())));
                    ...
                    {
                        if((GET_MHL3_RX3_WAIT_SRC_RAP_CBUS_UP_TMOUT() == _TRUE) || (GET_MHL3_RX3_WAIT_SRC_MHL_VERSION_TMOUT() == _TRUE))
                        {
#if(_MHL3_ECBUS_STARTUP_DEBUG_MESSAGE == _ON)
                            DebugMessageMHL("-- 3-2 -- Wait Source Rap Mpde Up TMOUT", ((GET_MHL3_RX3_WAIT_SRC_RAP_CBUS_UP_TMOUT() << 1) | (GET_MHL3_RX3_WAIT_SRC_MHL_VERSION_TMOUT())));
#endif
                            // MHL3 Wait RAP_CBUS_UP TMOUT -> Back to MHL2 //
                            // Enable Stuck Low IRQ and Clear Stuck Low Flags //
                            ScalerSetBit(P68_A4_CBUS_CTRL_04, ~(_BIT1 | _BIT0), _BIT0);

                            ScalerTimerDelayXms(80);

                            if(ScalerMHLRx3MscSendCommand(_MSC_SET_HPD, _MSC_NULL_ADDRESS, _MSC_NULL_VALUE) == _SUCCESS)
                            {
                                DebugMessageMHL("D3 MHL HPD Done", (0x20 | (GET_MHL3_RX3_ECBUS_START_UP_TMOUT())));

                                SET_MHL_RX3_PROCESS_STATE(_MHL_STATE_HPD_DONE);
                            }
                        }
                        else if((GET_MHL3_RX3_ECBUS_START_UP_TMOUT() == _TRUE) && (GET_MHL3_RX3_ECBUS_MODE() == _ON))
                        {
#if(_MHL3_ECBUS_STARTUP_DEBUG_MESSAGE == _ON)
                            DebugMessageMHL("-- 3-3 -- GET_MHL3_ECBUS_START_UP_TMOUT", GET_MHL3_RX3_ECBUS_START_UP_TMOUT());
#endif
            ...
            case _MHL_STATE_HPD_DONE:
                ...
                if(GET_MHL3_RX3_ECBUS_MODE() == _ON)
                {
                    ...
                    if(GET_MHL3_RX3_MSC_FEAT_REQ_UNCOMPLETE() == _FALSE)
                    {
                        if(ScalerMHLRx3MscSendCommand(_MSC_WRITE_STAT, _MSC_LINK_MODE, _MSC_PATH_EN) == _SUCCESS)
                        {
                            DebugMessageMHL("D3 MHL Path Enabled", 0x10);
            ...
            case _MHL_STATE_PATH_EN_DONE:
                ...
                if(GET_TMDS_RX3_PHY_SET() == _TRUE)
                {
                    ...
                    if(GET_MHL3_RX3_ECBUS_MODE() == _ON)
                    {
                        ScalerMHLRx3MscSendCommand(_MSC_WRITE_XSTAT, _MSC_91_AVLINK_MODE_STATUS, _MSC_TMDS_NORMAL);
                    }
                ...
                {
                    if((GET_MHL3_RX3_ECBUS_MODE() == _ON) && (ScalerMHL3Rx3DataSignalDetect() == _TRUE))
                    {
                        if((GET_MHL3_RX3_AV_LINK_RATE() == _ECBUS_LINK_RATE_NULL) &&
                           (GET_MHL3_RX3_AV_LINK_N_CODE() == _ECBUS_N_CODE_NULL) &&
                           (ScalerGetByte(P2E_2C_HDCP_I2C_CTRL_6) == 0x10))
                        {
                            SET_MHL3_RX3_AV_LINK_RATE(_ECBUS_LINK_RATE_1_5);
                            SET_MHL3_RX3_AV_LINK_N_CODE(_ECBUS_N_CODE_1_5);
                            ...
                            DebugMessageMHL("D3 HDCP2.2 Auth Done", 0x00);
                        }
            ...
            case _MHL_STATE_BIST_TESTING:
                ...
                if((GET_MHL3_RX3_ECBUS_START_UP_TMOUT() == _TRUE) && (GET_MHL3_RX3_BIST_TESTING() == _ON))
                {
#if(_MHL3_BIST_FUNCTION_DEBUG_MESSAGE == _ON)
                    DebugMessageMHL("D3 BIST eCBUS Start Up Fail", 0x00);
#endif
                    ScalerMHLRx3CBUSResetProc();
                }

                if((GET_MHL3_RX3_ECBUS_PROCESS_STATE() == _MHL3_ECBUS_STATE_ECBUS_DONE) && (GET_MHL3_RX3_BIST_TESTING() == _ON))
                {
#if(_MHL3_BIST_FUNCTION_DEBUG_MESSAGE == _ON)
                    DebugMessageMHL("5 BIST Done", ScalerGetBit(P77_01_MHL_FIFO_CTRL, _BIT0));
#endif
                    ScalerMHLRx3CBUSResetProc();
                }
...
bit ScalerMHLRx3MscRAPHandler(void)
{
    ...
    if((bit)ScalerGetBit(P68_D4_CBUS_CTRL_34, _BIT3) == _TRUE)
    {
        ...
        if((ScalerGetByte(P68_D2_CBUS_CTRL_32) != 0x00) &&
           ((GET_MHL_RX3_ADOPTER_ID_HBYTE() == _UTS800_SL863_ADOPTER_ID_HBYTE) &&
            (GET_MHL_RX3_ADOPTER_ID_LBYTE() == _UTS800_SL863_ADOPTER_ID_LBYTE)))
        {
            // Clear Flag
        ...
        switch(ScalerGetByte(P68_DC_CBUS_CTRL_3C))
        {
            ...
            case _MSC_RAP_CBUS_MODE_DOWN:
                ...
                if(ScalerMHLRx3MscSendCommand(_MSC_MSG, _MSC_RAPK, _MSC_RAPK_NO_ERROR) == _TRUE)
                {
                    ScalerMHLRx3CBUSResetProc();
            ...
            case _MSC_RAP_CBUS_MODE_UP:
                ...
                if(ScalerMHLRx3MscSendCommand(_MSC_MSG, _MSC_RAPK, _MSC_RAPK_NO_ERROR) == _TRUE)
                {
                    if(GET_MHL3_RX3_ECBUS_MODE() == _OFF)
                    {
                        //-------- Disable Stuck Low IRQ and Clear Stuck Low Flags --------//
                        ...
                        ScalerSetBit(P2C_3C_ECBUS_SRAM_BIST, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
