...
#define GET_AUDIO_D7_DP_DUAL_STATUS()               (g_bAudioDpDualStatus)
#define SET_AUDIO_D7_DP_DUAL_STATUS()               (g_bAudioDpDualStatus = _TRUE)
#define CLR_AUDIO_D7_DP_DUAL_STATUS()               (g_bAudioDpDualStatus = _FALSE)
#endif
