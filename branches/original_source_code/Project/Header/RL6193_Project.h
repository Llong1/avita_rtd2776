...
// Panel Option
//--------------------------------------------------
#define _PANEL_TYPE                                             _INNOLUX_LED_VBO_28_UHD
...
#define _FREEZE_SUPPORT                                         _ON
#define _ROTATION_FREEZE_FORCE_TO_BACKGROUND    _ON



#define _PIP_BLENDING_SUPPORT                             _ON
#define _DISP_LATENCY_ADJUST_SUPPORT                            _ON
