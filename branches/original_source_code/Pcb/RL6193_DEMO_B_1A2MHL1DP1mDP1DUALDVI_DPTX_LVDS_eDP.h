...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_DEMO_B_1A2MHL1DP1mDP1DUALDVI_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6193_DEMO_B_1A2MHL1DP1mDP1DUALDVI_DPTX_LVDS_eDP)
...
#define _D2_CBUS_CHANNEL_SEL                    _CBUS2
...
#define _D3_CBUS_CHANNEL_SEL                    _CBUS3
...
// VTX_PLL_LOCK
#define _PIN_AH18                               (4 & 0x07) // Page 10-0x39[2:0]
// 0 ~ 4 (0: P9D1i<I>, 1: P9D1o<PP>, 2: P9D1o<OD>, 3: Vb1_lock_n, 4: Dptx_hpd2_org)

// VTX_HPD
#define _PIN_AH16                               (4 & 0x07) // Page 10-0x3A[2:0]
...
// DP_HOT_PLUG_1
#define _PIN_AH3                                (1 & 0x07) // Page 10-0x5B[2:0]
...
#define bD1_DP_PIN16_CONNECT                    (MCU_FE38_PORTB0_PIN_REG)   // Pin_AD28, PB.0
...
#define bD2_CONNECT                             (MCU_FE3A_PORTB2_PIN_REG)   // Pin_AC29, PB.2
#define bD3_CONNECT                             (MCU_FE39_PORTB1_PIN_REG)   // Pin_AH26, PB.1
#define bD4_CONNECT                             (MCU_FE3B_PORTB3_PIN_REG)   // Pin_AH24, PB.3
...
//-----------------------------------------------
#define bD2_MHL_CONNECT                         (MCU_FE5C_PORTF4_PIN_REG) // Pin_N5, PF.4
#define bD3_MHL_CONNECT                         (MCU_FE5A_PORTF2_PIN_REG) // Pin_N6, PF.2
...
#define bD2_HPD                                 (MCU_FE5B_PORTF3_PIN_REG) // Pin_A4, PF.3
#define bD3_HPD                                 (MCU_FE59_PORTF1_PIN_REG) // Pin_A3, PF.1
#define bD4_HPD                                 (MCU_FE48_PORTD0_PIN_REG) // Pin_AK4, PD.0
...
//-----------------------------------------------
#define bD2_MHL_VBUS_SWITCH                     (MCU_FE2F_PORT97_PIN_REG) // Pin_AG29, P9.7
#define bD3_MHL_VBUS_SWITCH                     (MCU_FE30_PORTA0_PIN_REG) // Pin_AE28, PA.0
