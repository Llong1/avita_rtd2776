...
#define _D2_EMBEDDED_DDCRAM_SIZE_MULTI_EDID_0   _EDID_SIZE_NONE
#define _D2_EMBEDDED_DDCRAM_SIZE_MULTI_EDID_1   _EDID_SIZE_NONE
...
#define _INPUT_PORT_SEARCH_PRI_7                _D7_INPUT_PORT
