...
#define _D1_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_USER // external edid
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) //  (MCU_FE31_PORTA1_PIN_REG) // Pin_AG28, PA.1
...
//-----------------------------------------------
#define bAudioDetect                           (MCU_EMPTY_PIN_ASSIGN_ADDRESS) //  (MCU_FE32_PORTA2_PIN_REG) // Pin_AC28, PA.2
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL               (MCU_EMPTY_PIN_ASSIGN_ADDRESS)     //  (MCU_FE26_PORT86_PIN_REG) // Pin_AK15, P8.6
