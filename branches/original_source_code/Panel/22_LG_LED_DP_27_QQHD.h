...
#define _PANEL_DH_TOTAL                         5400                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     5448                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     5200                // Mininum Display Horizontal Total Clock Number in One Display Line

#define _PANEL_DV_START                         6                   // Display Vertical Start Position
#define _PANEL_DV_HEIGHT                        2880                // Display Vertical Width
#define _PANEL_DV_END                           2886                // Display Vertical End Position

#define _PANEL_DV_TOTAL                         2962                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     3002                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     2922                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      959                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  998                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  878                 // Mininum Pixel Clock in MHz
